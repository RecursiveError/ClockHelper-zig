...
pub const Config = struct {
    ...
    PLLI2SSRC: PLLI2SSourceConf = .RCC_PLLI2SCLKSOURCE_PLLSRC,
    ...
    I2S1Mult: I2S1CLockSelectionConf = .RCC_I2SAPB1CLKSOURCE_PLLI2S,
    I2S2Mult: I2S2CLockSelectionConf = .RCC_I2SAPB2CLKSOURCE_PLLI2S,
    FMPI2C1Mult: FMPI2C1SelectionConf = .RCC_FMPI2C1CLKSOURCE_APB,
    DFSDMMult: DFSDMSelectionConf = .RCC_DFSDM1CLKSOURCE_APB2,
    USBMult: USBCLockSelectionConf = .RCC_CLK48CLKSOURCE_PLLQ,
    SDIOMult: SDIOCLockSelectionConf = .RCC_SDIOCLKSOURCE_CLK48,
    DFSDMAudioMult: DFSDMAudioSelectionConf = .RCC_DFSDM1AUDIOCLKSOURCE_I2SAPB1,
    DFSDM2AudioMult: DFSDM2AudioSelectionConf = .RCC_DFSDM2AUDIOCLKSOURCE_I2SAPB1,
    SAI1AMult: SAI1ACLockSourceSelectionConf = .RCC_SAIACLKSOURCE_PLLSRC,
    SAI1APrescaler: PLLDivRConf = @enumFromInt(1),
    SAI1BMult: SAI1BCLockSourceSelectionConf = .RCC_SAIBCLKSOURCE_PLLSRC,
    SAI1BPrescaler: PLLI2SDivRConf = @enumFromInt(1),
    LPTimerMult: LPTIM1CLockSelectionConf = .RCC_LPTIM1CLKSOURCE_PCLK,
...
pub const ConfigWithRef = struct {
    ...
    PLLM: PLLMConf = @enumFromInt(16),
    PLLI2SSource: PLLI2SSourceConf = .RCC_PLLI2SCLKSOURCE_PLLSRC,
    PLLI2SM: PLLI2SMConf = @enumFromInt(16),
    SYSCLKSource: SYSCLKSourceConf = .RCC_SYSCLKSOURCE_HSI,
    ...
    I2S1CLockSelection: I2S1CLockSelectionConf = .RCC_I2SAPB1CLKSOURCE_PLLI2S,
    I2S2CLockSelection: I2S2CLockSelectionConf = .RCC_I2SAPB2CLKSOURCE_PLLI2S,
    FMPI2C1Selection: FMPI2C1SelectionConf = .RCC_FMPI2C1CLKSOURCE_APB,
    DFSDMSelection: DFSDMSelectionConf = .RCC_DFSDM1CLKSOURCE_APB2,
    ...
    DFSDMAudioSelection: DFSDMAudioSelectionConf = .RCC_DFSDM1AUDIOCLKSOURCE_I2SAPB1,
    DFSDM2AudioSelection: DFSDM2AudioSelectionConf = .RCC_DFSDM2AUDIOCLKSOURCE_I2SAPB1,
    SAI1ACLockSourceSelection: SAI1ACLockSourceSelectionConf = .RCC_SAIACLKSOURCE_PLLSRC,
    PLLDivR: PLLDivRConf = @enumFromInt(1),
    SAI1BCLockSourceSelection: SAI1BCLockSourceSelectionConf = .RCC_SAIBCLKSOURCE_PLLSRC,
    PLLI2SDivR: PLLI2SDivRConf = @enumFromInt(1),
...
pub const ClockTree = struct {
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const DFSDM2AudioMultval = ClockNodeTypes{ .multi = @intFromEnum(config.DFSDM2AudioMult) };
        ...
        const SAI1APrescalerval = ClockNodeTypes{
            .div = .{
                .value = config.SAI1APrescaler.get(),
                .limit = .{ .max = 32, .min = 1 },
            },
        };
        ...
        const SAI1BPrescalerval = ClockNodeTypes{
            .div = .{
                .value = config.SAI1BPrescaler.get(),
                .limit = .{ .max = 32, .min = 1 },
            },
        };
        ...
        const SAI1AMultval = ClockNodeTypes{ .multi = @intFromEnum(config.SAI1AMult) };
        ...
        const SAI1BMultval = ClockNodeTypes{ .multi = @intFromEnum(config.SAI1BMult) };
        ...
        const LPTimerMultval = ClockNodeTypes{ .multi = @intFromEnum(config.LPTimerMult) };
