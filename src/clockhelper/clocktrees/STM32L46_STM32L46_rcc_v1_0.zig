    ...
    return struct {
            ...
            pub fn from_enum(item: RCC_SAI1SEL) anyerror!@This() {
                return switch (item) {
                    ...
                    .PLLSAI1_P => .RCC_SAI1CLKSOURCE_PLLSAI1,
                        ...
                        .{ "RCC_SAI1SEL", @tagName(item), "SAI1CLockSelection" },
                    ),
                };
            }
        };
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            const PLLUsedValue: u1 = blk: {
                if (((SAI1SourcePLLP and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) or (SysSourcePLL) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_PLLCLK, .@"=")) and ((config.flags.Semaphore_input_Channel1TIM16 and config.flags.TIM16 and config.flags.SEM2RCC_MCO_REQUIRED_TIM16) or config.flags.MCOConfig)) or (CK48SourcePLLCLK and (config.flags.USBUsed_ForRCC or config.flags.RNGUsed_ForRCC or config.flags.SDMMC1Used_ForRCC))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PLLSAI1UsedValue: u1 = blk: {
                if (((SAI1SourcePLLSAI1P and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) or (ADCSourcePLLSAI1R and (config.flags.USE_ADC1 or config.flags.USE_ADC2 or config.flags.USE_ADC3)) or (CK48SourcePLLSAI1 and (config.flags.USBUsed_ForRCC or config.flags.RNGUsed_ForRCC or config.flags.SDMMC1Used_ForRCC))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSIAutoCalibrationValue: MSIAutoCalibrationList = blk: {
                if (config.flags.USBUsed_ForRCC and (CK48SourceMSI or (CK48SourcePLLCLK and PLLSourceMSI) or (CK48SourcePLLSAI1 and PLLSourceMSI)) and (config.flags.LSEOscillator or config.flags.LSEByPass)) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .ENABLED) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "USBUsed_ForRCC&(CK48SourceMSI|(CK48SourcePLLCLK&PLLSourceMSI)|(CK48SourcePLLSAI1&PLLSourceMSI))& (LSEOscillator | LSEByPass)",
                                "",
                                "ENABLED",
                                val,
                            });
            ...
            const MCOEnableValue: MCOEnableList = blk: {
                if ((config.flags.Semaphore_input_Channel1TIM16 and config.flags.TIM16 and config.flags.SEM2RCC_MCO_REQUIRED_TIM16) or config.flags.MCOConfig) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            if (config.flags.USBUsed_ForRCC and (config.flags.USE_ADC1 or config.flags.USE_ADC2 or config.flags.USE_ADC3) and (!config.flags.ADC1UsedAsynchronousCLK_ForRCC or !config.flags.ADC2UsedAsynchronousCLK_ForRCC or !config.flags.ADC3UsedAsynchronousCLK_ForRCC)) {
                AHBOutput.limit = .{
                    .min = 1.42e7,
                    .max = 8e7,
                    .main_expr = "USBUsed_ForRCC & (USE_ADC1|USE_ADC2|USE_ADC3) & (!ADC1UsedAsynchronousCLK_ForRCC|!ADC2UsedAsynchronousCLK_ForRCC|!ADC3UsedAsynchronousCLK_ForRCC)",
            ...
            if (((SAI1SourcePLLP and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) and scale1) {
                PLLPoutput.limit = .{
                    .min = 2.064e6,
                    .max = 8e7,
                    .main_expr = "((SAI1SourcePLLP&(SAI1Used_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) & scale1",
                    .main_dialog = " ",
                };
            } else if (((SAI1SourcePLLP and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) and scale2) {
                PLLPoutput.limit = .{
                    .min = 2.064e6,
                    .max = 2.6e7,
                    .main_expr = "((SAI1SourcePLLP&(SAI1Used_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) & scale2",
                    .main_dialog = " ",
                };
            }
            ...
            if (((config.flags.USBUsed_ForRCC or config.flags.RNGUsed_ForRCC or config.flags.SDMMC1Used_ForRCC) and CK48SourcePLLCLK) and scale1) {
                PLLQoutput.limit = .{
                    .min = 8e6,
                    .max = 8e7,
                    .main_expr = "((USBUsed_ForRCC|RNGUsed_ForRCC|SDMMC1Used_ForRCC)& CK48SourcePLLCLK) & scale1",
                    .main_dialog = " ",
                };
                ...
                PLLQoutput.limit = .{
                    .min = 8e6,
                    .max = 2.6e7,
                    .main_expr = "((USBUsed_ForRCC|RNGUsed_ForRCC|SDMMC1Used_ForRCC)& CK48SourcePLLCLK) & scale2",
                    .main_dialog = " ",
                };
            }
            ...
            if (((SAI1SourcePLLSAI1P and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) and scale1) {
                PLLSAI1Poutput.limit = .{
                    .min = 2.064e6,
                    .max = 8e7,
                    .main_expr = "((SAI1SourcePLLSAI1P&(SAI1Used_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) & scale1",
                    .main_dialog = " ",
                };
            } else if (((SAI1SourcePLLSAI1P and (config.flags.SAI1Used_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) and scale2) {
                PLLSAI1Poutput.limit = .{
                    .min = 2.064e6,
                    .max = 2.6e7,
                    .main_expr = "((SAI1SourcePLLSAI1P&(SAI1Used_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))) & scale2",
                    .main_dialog = " ",
                };
            }
            ...
            if (((config.flags.USBUsed_ForRCC or config.flags.RNGUsed_ForRCC or config.flags.SDMMC1Used_ForRCC) and CK48SourcePLLSAI1) and scale1) {
                PLLSAI1Qoutput.limit = .{
                    .min = 8e6,
                    .max = 8e7,
                    .main_expr = "((USBUsed_ForRCC|RNGUsed_ForRCC|SDMMC1Used_ForRCC)& CK48SourcePLLSAI1) & scale1",
                    .main_dialog = " ",
                };
                ...
                PLLSAI1Qoutput.limit = .{
                    .min = 8e6,
                    .max = 2.6e7,
                    .main_expr = "((USBUsed_ForRCC|RNGUsed_ForRCC|SDMMC1Used_ForRCC)& CK48SourcePLLSAI1) & scale2",
                    .main_dialog = " ",
                };
            }
            ...
            if ((check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAI1UsedValue), PLLSAI1UsedValue, 1, .@"="))) {
                VCOInput.limit = .{
                    .min = 4e6,
                    .max = 1.6e7,
