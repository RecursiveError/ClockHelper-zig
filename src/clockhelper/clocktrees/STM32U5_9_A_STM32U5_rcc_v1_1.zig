...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const USART6CLockSelectionVirtualList = enum {
        ...
        pub const HSPICLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_HSPISEL {
                return switch (self) {
                    .RCC_HSPICLKSOURCE_SYSCLK => .SYS,
                    .RCC_HSPICLKSOURCE_PLL3 => .PLL3_R,
                    .RCC_HSPICLKSOURCE_PLL2 => .PLL2_Q,
                    .RCC_HSPICLKSOURCE_PLL1 => .PLL1_Q,
                };
            }
            pub fn from_enum(item: RCC_HSPISEL) anyerror!@This() {
                return switch (item) {
                    .SYS => .RCC_HSPICLKSOURCE_SYSCLK,
                    .PLL3_R => .RCC_HSPICLKSOURCE_PLL3,
                    .PLL2_Q => .RCC_HSPICLKSOURCE_PLL2,
                    .PLL1_Q => .RCC_HSPICLKSOURCE_PLL1,
                };
            }
        };
        ...
        pub const LTDCCLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_LTDCSEL {
                return switch (self) {
                    .RCC_LTDCCLKSOURCE_PLL3 => .PLL3_R,
                    .RCC_LTDCCLKSOURCE_PLL2 => .PLL2_R,
                };
            }
            pub fn from_enum(item: RCC_LTDCSEL) anyerror!@This() {
                return switch (item) {
                    .PLL3_R => .RCC_LTDCCLKSOURCE_PLL3,
                    .PLL2_R => .RCC_LTDCCLKSOURCE_PLL2,
                };
            }
        };
        ...
        pub const I2C5CLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_I2CSEL {
                return switch (self) {
                    .RCC_I2C5CLKSOURCE_PCLK1 => .PCLK1,
                    .RCC_I2C5CLKSOURCE_SYSCLK => .SYS,
                    .RCC_I2C5CLKSOURCE_MSIK => .MSIK,
                    .RCC_I2C5CLKSOURCE_HSI => .HSI,
                };
            }
            pub fn from_enum(item: RCC_I2CSEL) anyerror!@This() {
                return switch (item) {
                    .PCLK1 => .RCC_I2C5CLKSOURCE_PCLK1,
                    .SYS => .RCC_I2C5CLKSOURCE_SYSCLK,
                    .MSIK => .RCC_I2C5CLKSOURCE_MSIK,
                    .HSI => .RCC_I2C5CLKSOURCE_HSI,
                };
            }
        };
        ...
        pub const I2C6CLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_I2CSEL {
                return switch (self) {
                    .RCC_I2C6CLKSOURCE_PCLK1 => .PCLK1,
                    .RCC_I2C6CLKSOURCE_HSI => .HSI,
                    .RCC_I2C6CLKSOURCE_MSIK => .MSIK,
                    .RCC_I2C6CLKSOURCE_SYSCLK => .SYS,
                };
            }
            pub fn from_enum(item: RCC_I2CSEL) anyerror!@This() {
                return switch (item) {
                    .PCLK1 => .RCC_I2C6CLKSOURCE_PCLK1,
                    .HSI => .RCC_I2C6CLKSOURCE_HSI,
                    .MSIK => .RCC_I2C6CLKSOURCE_MSIK,
                    .SYS => .RCC_I2C6CLKSOURCE_SYSCLK,
                };
            }
        };
        ...
        pub const USBPHYCLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_ICLKSEL {
                return switch (self) {
                    .RCC_USBPHYCLKSOURCE_HSE_DIV2 => .MSIK,
                    .RCC_USBPHYCLKSOURCE_PLL1_DIV2 => .PLL2_Q,
                    .RCC_USBPHYCLKSOURCE_PLL1 => .PLL1_Q,
                    .RCC_USBPHYCLKSOURCE_HSE => .HSI48,
                };
            }
            pub fn from_enum(item: RCC_ICLKSEL) anyerror!@This() {
                return switch (item) {
                    .MSIK => .RCC_USBPHYCLKSOURCE_HSE_DIV2,
                    .PLL2_Q => .RCC_USBPHYCLKSOURCE_PLL1_DIV2,
                    .PLL1_Q => .RCC_USBPHYCLKSOURCE_PLL1,
                    .HSI48 => .RCC_USBPHYCLKSOURCE_HSE,
                };
            }
        };
        ...
        pub const Flags = struct {
            ...
            RCC_MCO1SOURCE_PLL1CLK: bool = false,
        ...
        pub const OutputFlags = struct {
            ...
            HSPI1Enable: bool = false, //Reference flag
            ...
            I2C5Enable: bool = false, //Reference flag
            I2C6Enable: bool = false, //Reference flag
            ...
            UCPD1Enable: bool = false, //Reference flag
            SPI1Enable: bool = false, //Reference flag
            SPI3Enable: bool = false, //Reference flag
            SPI2Enable: bool = false, //Reference flag
            USBPHYEnableHSE: bool = false, //Reference flag
            USBPHYEnable: bool = false, //Reference flag
            EnableDSI: bool = false, //Reference flag
            USBPHYEnablePll: bool = false, //Reference flag
        ...
        pub const CubeMXConfig = struct {
            ...
            USART6CLockSelectionVirtual: ?USART6CLockSelectionVirtualList = null,
        ...
        pub const CubeMXOutputConfig = struct {
            ...
            USART6CLockSelectionVirtual: USART6CLockSelectionVirtualList,
            ...
            HSPICLockSelection: HSPICLockSelectionList,
            LTDCCLockSelection: LTDCCLockSelectionList,
            ...
            I2C5CLockSelection: I2C5CLockSelectionList,
            I2C6CLockSelection: I2C6CLockSelectionList,
            ...
            HSEDiv2: u32,
            PLL1PDiv2: u32,
            USBPHYCLockSelection: USBPHYCLockSelectionList,
            DSIPHY_Div: u32,
        ...
        pub const Config = struct {
            ...
            USART6CLockSelectionVirtual: ?RCC_USARTSEL = null,
            ...
            HSPICLockSelection: ?RCC_HSPISEL = null,
            LTDCCLockSelection: ?RCC_LTDCSEL = null,
            LPTIM1CLockSelectionVirtual: ?RCC_LPTIMSEL = null,
            ...
            I2C5CLockSelection: ?RCC_I2CSEL = null,
            I2C6CLockSelection: ?RCC_I2CSEL = null,
            ...
            USBPHYCLockSelection: ?RCC_ICLKSEL = null,
            ...
            pub fn to_cubemx_config(self: Config) !CubeMXConfig {
                return CubeMXConfig{
                    ...
                    .USART6CLockSelectionVirtual = if (self.USART6CLockSelectionVirtual) |val| try USART6CLockSelectionVirtualList.from_enum(val) else null,
                    ...
                    .HSPICLockSelection = if (self.HSPICLockSelection) |val| try HSPICLockSelectionList.from_enum(val) else null,
                    .LTDCCLockSelection = if (self.LTDCCLockSelection) |val| try LTDCCLockSelectionList.from_enum(val) else null,
                    ...
                    .I2C5CLockSelection = if (self.I2C5CLockSelection) |val| try I2C5CLockSelectionList.from_enum(val) else null,
                    .I2C6CLockSelection = if (self.I2C6CLockSelection) |val| try I2C6CLockSelectionList.from_enum(val) else null,
                    ...
                    .USBPHYCLockSelection = if (self.USBPHYCLockSelection) |val| try USBPHYCLockSelectionList.from_enum(val) else null,
        ...
        pub const OutputConfig = struct {
            ...
            USART6CLockSelectionVirtual: RCC_USARTSEL,
            ...
            HSPICLockSelection: RCC_HSPISEL,
            LTDCCLockSelection: RCC_LTDCSEL,
            LPTIM1CLockSelectionVirtual: RCC_LPTIMSEL,
            ...
            I2C5CLockSelection: RCC_I2CSEL,
            I2C6CLockSelection: RCC_I2CSEL,
            ...
            HSEDiv2: u32,
            PLL1PDiv2: u32,
            USBPHYCLockSelection: RCC_ICLKSEL,
            DSIPHY_Div: u32,
            ...
            pub fn from_cubemx_output_config(cubemx_config: CubeMXOutputConfig) !OutputConfig {
                return OutputConfig{
                    ...
                    .USART6CLockSelectionVirtual = try cubemx_config.USART6CLockSelectionVirtual.to_enum(),
                    ...
                    .HSPICLockSelection = try cubemx_config.HSPICLockSelection.to_enum(),
                    .LTDCCLockSelection = try cubemx_config.LTDCCLockSelection.to_enum(),
                    ...
                    .I2C5CLockSelection = try cubemx_config.I2C5CLockSelection.to_enum(),
                    .I2C6CLockSelection = try cubemx_config.I2C6CLockSelection.to_enum(),
                    ...
                    .HSEDiv2 = cubemx_config.HSEDiv2,
                    .PLL1PDiv2 = cubemx_config.PLL1PDiv2,
                    .USBPHYCLockSelection = try cubemx_config.USBPHYCLockSelection.to_enum(),
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            var HSPICLKSOURCE_PLL1: bool = false; //semaphore for processing, not an actual flag in the output;
            var HSPICLKSOURCE_PLL2: bool = false; //semaphore for processing, not an actual flag in the output;
            var HSPICLKSOURCE_PLL3: bool = false; //semaphore for processing, not an actual flag in the output;
            var LTDCCLKSOURCE_PLL2: bool = false; //semaphore for processing, not an actual flag in the output;
            var LTDCCLKSOURCE_PLL3: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var I2C5SourceHSI: bool = false; //semaphore for processing, not an actual flag in the output;
            var I2C5CLKSOURCE_MSIK: bool = false; //semaphore for processing, not an actual flag in the output;
            var I2C5SourceSys: bool = false; //semaphore for processing, not an actual flag in the output;
            var I2C6SourceHSI: bool = false; //semaphore for processing, not an actual flag in the output;
            var I2C6CLKSOURCE_MSIK: bool = false; //semaphore for processing, not an actual flag in the output;
            var I2C6SourceSys: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var USBPHYCLKSOURCE_HSE_DIV2: bool = false; //semaphore for processing, not an actual flag in the output;
            var USBPHYCLKSOURCE_PLL1: bool = false; //semaphore for processing, not an actual flag in the output;
            var USBPHYCLKSOURCE_PLL1_DIV2: bool = false; //semaphore for processing, not an actual flag in the output;
            var DSISourceisPLL3: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            const MSIClockRangeValue: MSIClockRangeList = blk: {
                ...
                } else if (config.flags.S_LPBAM_CONF) {
                    const user_val = config.MSIClockRange;
            ...
            const USBPHYCLockSelectionValue: USBPHYCLockSelectionList = blk: {
                const user_val = config.USBPHYCLockSelection;
                ...
                break :blk user_val orelse {
                    USBPHYCLKSOURCE_PLL1 = true;
                    break :blk .RCC_USBPHYCLKSOURCE_PLL1;
                };
            };
                ...
                if ((config.flags.USB_OTG_HS_Used or config.flags.OTG_HS_Used) and (USBPHYCLKSOURCE_PLL1 or USBPHYCLKSOURCE_PLL1_DIV2)) {
                    if (config.PLLSourceVirtual) |val| {
                        if (val != .RCC_PLLSOURCE_HSE) {
                            ...
                            , .{
                                "PLLSourceVirtual",
                                "(USB_OTG_HS_Used|OTG_HS_Used)&(USBPHYCLKSOURCE_PLL1|USBPHYCLKSOURCE_PLL1_DIV2)",
                                "Only HSE is possible when OTG_HS is using PLL1",
                                patch_str,
                                val_enum,
                            });
                        }
            ...
            const USART1CLockSelectionVirtualValue: USART1CLockSelectionVirtualList = blk: {
                if (config.flags.S_LPBAM_CONF and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
            ...
            const USART6CLockSelectionVirtualValue: USART6CLockSelectionVirtualList = blk: {
                if (config.flags.S_LPBAM_CONF and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    if (config.USART6CLockSelectionVirtual) |val| {
                        if (val != .RCC_USART6CLKSOURCE_HSI) {
                            const patch_str = if (patch_logs) "HSI" else "RCC_USART6CLKSOURCE_HSI";
                            const val_enum = if (patch_logs) @tagName(try val.to_enum()) else @tagName(val);
                            return comptime_fail_or_error(error.InvalidConfig,
                                \\
                                \\Error on {s} | expr: {s} diagnostic: {s} 
                    ...
                    break :blk .RCC_USART6CLKSOURCE_HSI;
                } else if (config.flags.S_LPBAM_CONF) {
                    const user_val = config.USART6CLockSelectionVirtual;
                        ...
                        switch (val) {
                            ...
                            .RCC_USART6CLKSOURCE_LSE => USART6SourceLSE = true,
                                ...
                                , .{
                                    ...
                                    "",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                                    if (patch_logs) "HSI" else "RCC_USART6CLKSOURCE_HSI",
                                    if (patch_logs) "LSE" else "RCC_USART6CLKSOURCE_LSE",
                                });
                            },
                        }
                    }
                        ...
                        switch (val) {
                            ...
                            .RCC_USART6CLKSOURCE_HSI => USART6SourceHSI = true,
                                ...
                                , .{
                                    ...
                                    "LSE is configured only for RTC",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                                    if (patch_logs) "PCLK1" else "RCC_USART6CLKSOURCE_PCLK1",
                                    if (patch_logs) "SYS" else "RCC_USART6CLKSOURCE_SYSCLK",
                                    if (patch_logs) "HSI" else "RCC_USART6CLKSOURCE_HSI",
                                });
                            },
                        }
                    ...
                    break :blk user_val orelse {
                        ...
                        break :blk .RCC_USART6CLKSOURCE_PCLK1;
                    };
                }
                const user_val = config.USART6CLockSelectionVirtual;
            ...
            const HSPICLockSelectionValue: HSPICLockSelectionList = blk: {
                const user_val = config.HSPICLockSelection;
                ...
                break :blk user_val orelse .RCC_HSPICLKSOURCE_SYSCLK;
            };

            const LTDCCLockSelectionValue: LTDCCLockSelectionList = blk: {
                const user_val = config.LTDCCLockSelection;
                ...
                break :blk user_val orelse {
                    LTDCCLKSOURCE_PLL2 = true;
                    break :blk .RCC_LTDCCLKSOURCE_PLL2;
                };
            };
                        ...
                        switch (val) {
                            ...
                            .RCC_LPTIM1CLKSOURCE_HSI => LPTIM1SOURCEHSI = true,
                                ...
                                , .{
                                    ...
                                    "LSE is configured only for RTC",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                                    if (patch_logs) "MSIK" else "RCC_LPTIM1CLKSOURCE_MSIK",
            ...
            const CK48CLockSelectionValue: CK48CLockSelectionList = blk: {
                if (config.flags.S_LPBAM_CONF) {
                    if (config.CK48CLockSelection) |val| {
                        if (val != .RCC_CLK48CLKSOURCE_MSIK) {
                            const patch_str = if (patch_logs) "MSIK" else "RCC_CLK48CLKSOURCE_MSIK";
                            const val_enum = if (patch_logs) @tagName(try val.to_enum()) else @tagName(val);
                            return comptime_fail_or_error(error.InvalidConfig,
                                \\
                                \\Error on {s} | expr: {s} diagnostic: {s} 
            ...
            const SDMMCClockSelectionValue: SDMMCClockSelectionList = blk: {
                if (config.flags.S_LPBAM_CONF) {
                    if (config.SDMMCClockSelection) |val| {
                        if (val != .RCC_SDMMCCLKSOURCE_CLK48) {
                            const patch_str = if (patch_logs) "ICLK" else "RCC_SDMMCCLKSOURCE_CLK48";
                            const val_enum = if (patch_logs) @tagName(try val.to_enum()) else @tagName(val);
                            return comptime_fail_or_error(error.InvalidConfig,
                                \\
                                \\Error on {s} | expr: {s} diagnostic: {s} 
            ...
            const I2C5CLockSelectionValue: I2C5CLockSelectionList = blk: {
                if (config.flags.S_LPBAM_CONF) {
                    const user_val = config.I2C5CLockSelection;
                        ...
                        switch (val) {
                            ...
                            .RCC_I2C5CLKSOURCE_MSIK => I2C5CLKSOURCE_MSIK = true,
                                ...
                                , .{
                                    ...
                                    "",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                                    if (patch_logs) "HSI" else "RCC_I2C5CLKSOURCE_HSI",
                                    if (patch_logs) "MSIK" else "RCC_I2C5CLKSOURCE_MSIK",
                                });
                            },
                        }
                    }
                    break :blk user_val orelse {
                        I2C5SourceHSI = true;
                        break :blk .RCC_I2C5CLKSOURCE_HSI;
                    };
                }
                const user_val = config.I2C5CLockSelection;
                ...
                break :blk user_val orelse .RCC_I2C5CLKSOURCE_PCLK1;
            };

            const I2C6CLockSelectionValue: I2C6CLockSelectionList = blk: {
                if (config.flags.S_LPBAM_CONF) {
                    const user_val = config.I2C6CLockSelection;
                        ...
                        switch (val) {
                            ...
                            .RCC_I2C6CLKSOURCE_MSIK => I2C6CLKSOURCE_MSIK = true,
                                ...
                                , .{
                                    ...
                                    "",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                                    if (patch_logs) "HSI" else "RCC_I2C6CLKSOURCE_HSI",
                                    if (patch_logs) "MSIK" else "RCC_I2C6CLKSOURCE_MSIK",
                                });
                            },
                        }
                    }
                    break :blk user_val orelse {
                        I2C6SourceHSI = true;
                        break :blk .RCC_I2C6CLKSOURCE_HSI;
                    };
                }
                const user_val = config.I2C6CLockSelection;
                ...
                break :blk user_val orelse .RCC_I2C6CLKSOURCE_PCLK1;
            };
            ...
            const HSEDiv2Value: u32 = blk: {
                break :blk 2;
            };

            const PLL1PDiv2Value: u32 = blk: {
                break :blk 2;
            };
                ...
                if ((check_ref(@TypeOf(LSEStateValue), LSEStateValue, .RCC_LSE_OFF, .@"=")) and (((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL1Q and PLLSourceMSI) or ((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL2Q and PLL2SourceMSI))) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIS) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(LSEState=RCC_LSE_OFF) & (((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL1Q&PLLSourceMSI)|((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL2Q&PLL2SourceMSI))",
                                "",
                                "PLLMODE_MSIS",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIS) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL1Q&PLLSourceMSI)|((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL2Q&PLL2SourceMSI))",
                                "",
                                "PLLMODE_MSIS",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIK) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(LSEState=RCC_LSE_OFF) & ((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)) & CLK48CLKSOURCE_MSIK)",
                                "",
                                "PLLMODE_MSIK",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIK) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)) & CLK48CLKSOURCE_MSIK)",
                                "",
                                "PLLMODE_MSIK",
                                val,
                            });
            ...
            const PLL1RUsedValue: u1 = blk: {
                if (((SysSourcePLL) or ((check_ref(@TypeOf(RCC_MCO1SourceVirtualValue), RCC_MCO1SourceVirtualValue, .RCC_MCO1SOURCE_PLL1CLK, .@"=")) and ((config.flags.Semaphore_input_Channel1TIM17 and config.flags.TIM17 and config.flags.SEM2RCC_MCO_REQUIRED_TIM17) or config.flags.MCOConfig)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PLL2RUsedValue: u1 = blk: {
                if (LTDCCLKSOURCE_PLL2 and config.flags.LTDC_Used or (ADCSourcePLL2R and config.flags.DAC1) or (ADCSourcePLL2R and ((config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC2 and config.flags.ADCUsed_ForRCC) or (config.flags.USE_ADC4 and config.flags.ADCUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSISUsedValue: u32 = blk: {
                if (WakeUpClockMSI and config.flags.S_LPBAM_CONF) {
                    break :blk 1;
                } else if (!config.flags.S_LPBAM_CONF and ((check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_MSI, .@"=")) or ((check_ref(@TypeOf(RCC_MCO1SourceVirtualValue), RCC_MCO1SourceVirtualValue, .RCC_MCO1SOURCE_MSI, .@"=")) and ((config.flags.Semaphore_input_Channel1TIM17 and config.flags.TIM17 and config.flags.SEM2RCC_MCO_REQUIRED_TIM17) or config.flags.MCOConfig)) or PLLSourceMSI and check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or (PLL2SourceMSI and check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=")) or (PLL3SourceMSI and check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=")))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const RNGEnableLPBAMValue: RNGEnableLPBAMList = blk: {
                if (config.flags.RNGUsed_ForRCC and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const SDMMCEnableLPBAMValue: SDMMCEnableLPBAMList = blk: {
                if ((config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const SAI1EnableLPBAMValue: SAI1EnableLPBAMList = blk: {
                if ((config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const SAI2EnableLPBAMValue: SAI2EnableLPBAMList = blk: {
                if ((config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const MDF1EnableLPBAMValue: MDF1EnableLPBAMList = blk: {
                if (config.flags.MDF1_Used and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const ADF1EnableLPBAMValue: ADF1EnableLPBAMList = blk: {
                if (config.flags.ADF1_Used and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const FDCANEnableLPBAMValue: FDCANEnableLPBAMList = blk: {
                if (config.flags.FDCAN1Used_ForRCC and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const OCTOSPIMEnableLPBAMValue: OCTOSPIMEnableLPBAMList = blk: {
                if ((config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const ADCEnableLPBAMValue: ADCEnableLPBAMList = blk: {
                if (((config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC2 and config.flags.ADC2UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC4 and config.flags.ADCUsed_ForRCC)) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const DACEnableLPBAMValue: DACEnableLPBAMList = blk: {
                if (config.flags.DAC1 and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const FullHSI48UsedValue: u1 = blk: {
                if (RNGCLKSOURCE_HSI48 and config.flags.RNGUsed_ForRCC or (CK48SourceHSI48 and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or config.flags.CRSActivatedSourceGPIO or config.flags.CRSActivatedSourceLSE or config.flags.CRSActivatedSourceUSB or ((check_ref(@TypeOf(RCC_MCO1SourceVirtualValue), RCC_MCO1SourceVirtualValue, .RCC_MCO1SOURCE_HSI48, .@"=")) and ((((config.flags.Semaphore_input_Channel1TIM16 and config.flags.TIM16 and config.flags.SEM2RCC_MCO_REQUIRED_TIM16) or config.flags.MCOConfig))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const HSIUsedValue: u1 = blk: {
                if (WakeUpClockHSI and config.flags.S_LPBAM_CONF or USART6SourceHSI and config.flags.USART6_Used or SPI1CLKSOURCE_HSI and config.flags.SPI1Used_ForRCC or SPI2CLKSOURCE_HSI and config.flags.SPI2Used_ForRCC or SPI3CLKSOURCE_HSI and config.flags.SPI3Used_ForRCC or ADCSourceHSI and (((config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC2 and config.flags.ADCUsed_ForRCC) or (config.flags.USE_ADC4 and config.flags.ADCUsed_ForRCC)) or config.flags.DAC1) or (RNGCLKSOURCE_HSI and config.flags.RNGUsed_ForRCC) or (config.flags.UCPD1_Used) or (SAI2SourceHSI and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)) or (SAI1SourceHSI and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC)) or (USART1SourceHSI and config.flags.USART1Used_ForRCC) or (USART2SourceHSI and config.flags.USART2Used_ForRCC) or (USART3SourceHSI and config.flags.USART3Used_ForRCC) or (UART4SourceHSI and config.flags.UART4Used_ForRCC) or (UART5SourceHSI and config.flags.UART5Used_ForRCC) or (LPUART1SourceHSI and config.flags.LPUARTUsed_ForRCC) or (LPTIM1SOURCEHSI and config.flags.LPTIM1Used_ForRCC) or (LPTIM2SOURCEHSI and config.flags.LPTIM2Used_ForRCC) or (LPTIM3SOURCEHSI and (config.flags.LPTIM3Used_ForRCC or config.flags.LPTIM4Used_ForRCC)) or (I2C1SourceHSI and config.flags.I2C1Used_ForRCC) or (I2C2SourceHSI and config.flags.I2C2Used_ForRCC) or (I2C3SourceHSI and config.flags.I2C3Used_ForRCC) or (I2C4SourceHSI and config.flags.I2C4Used_ForRCC) or (I2C5SourceHSI and config.flags.I2C5Used_ForRCC) or (I2C6SourceHSI and config.flags.I2C6Used_ForRCC) or (config.flags.SWPMISourceHSI and config.flags.SWPMI1Used_ForRCC) or (PLLSourceHSI and check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=")) or (PLL2SourceHSI and check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=")) or (PLL3SourceHSI and check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=")) or (check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_HSI, .@"=")) or ((check_ref(@TypeOf(RCC_MCO1SourceVirtualValue), RCC_MCO1SourceVirtualValue, .RCC_MCO1SOURCE_HSI, .@"=")) and ((((config.flags.Semaphore_input_Channel1TIM17 and config.flags.TIM17 and config.flags.SEM2RCC_MCO_REQUIRED_TIM17) or config.flags.MCOConfig))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            USART6Mult.parents = switch (USART6CLockSelectionVirtualValue) {
            ...
            if (check_MCU("HSPI1_Exist")) {
                ...
                HSPIMult.parents = switch (HSPICLockSelectionValue) {
                    .RCC_HSPICLKSOURCE_SYSCLK => &.{&SysCLKOutput},
                    .RCC_HSPICLKSOURCE_PLL1 => &.{&PLL1Q},
                    .RCC_HSPICLKSOURCE_PLL2 => &.{&PLL2Q},
                    .RCC_HSPICLKSOURCE_PLL3 => &.{&PLL3R},
                };
            }
            // ======= NODE HSPIoutput ======
            if (check_MCU("HSPI1_Exist")) {
            ...
            if (check_MCU("LTDC_Exist")) {
                ...
                LTDCMult.parents = switch (LTDCCLockSelectionValue) {
                    .RCC_LTDCCLKSOURCE_PLL2 => &.{&PLL2R},
                    .RCC_LTDCCLKSOURCE_PLL3 => &.{&PLL3R},
                };
            }
            // ======= NODE LTDCoutput ======
            if (check_MCU("LTDC_Exist")) {
            ...
            if (check_MCU("I2C5_Exist")) {
                ...
                I2C5Mult.parents = switch (I2C5CLockSelectionValue) {
                    .RCC_I2C5CLKSOURCE_PCLK1 => &.{&APB1Prescaler},
                    .RCC_I2C5CLKSOURCE_SYSCLK => &.{&SysCLKOutput},
                    .RCC_I2C5CLKSOURCE_HSI => &.{&HSIRC},
                    .RCC_I2C5CLKSOURCE_MSIK => &.{&MSIKRC},
                };
            }
            // ======= NODE I2C5output ======
            if (check_MCU("I2C5_Exist")) {
            ...
            if (check_MCU("I2C6_Exist")) {
                ...
                I2C6Mult.parents = switch (I2C6CLockSelectionValue) {
                    .RCC_I2C6CLKSOURCE_PCLK1 => &.{&APB1Prescaler},
                    .RCC_I2C6CLKSOURCE_SYSCLK => &.{&SysCLKOutput},
                    .RCC_I2C6CLKSOURCE_HSI => &.{&HSIRC},
                    .RCC_I2C6CLKSOURCE_MSIK => &.{&MSIKRC},
                };
            }
            // ======= NODE I2C6output ======
            if (check_MCU("I2C6_Exist")) {
            ...
            HSEDiv2.value = @floatFromInt(HSEDiv2Value);
            HSEDiv2.parents = &.{&HSEOSC};

            // ======= NODE PLL1PDiv2 ======
            PLL1PDiv2.nodetype = .div;
            PLL1PDiv2.value = @floatFromInt(PLL1PDiv2Value);
            PLL1PDiv2.parents = &.{&PLL1P};

            // ======= NODE USBPHYMult ======
            USBPHYMult.nodetype = .multi;
            USBPHYMult.parents = switch (USBPHYCLockSelectionValue) {
                .RCC_USBPHYCLKSOURCE_HSE => &.{&HSEOSC},
                .RCC_USBPHYCLKSOURCE_HSE_DIV2 => &.{&HSEDiv2},
                .RCC_USBPHYCLKSOURCE_PLL1 => &.{&PLL1P},
                .RCC_USBPHYCLKSOURCE_PLL1_DIV2 => &.{&PLL1PDiv2},
            };
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if (config.flags.S_LPBAM_CONF) {
                    ...
                    break :blk null;
                } else if (((check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 25000000, .@"<")) or (check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 25000000, .@"="))) and !(check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=") or check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=") or check_ref(@TypeOf(FullHSI48UsedValue), FullHSI48UsedValue, 1, .@"=") or false and check_ref(@TypeOf(MSIKUsedValue), MSIKUsedValue, 1, .@"=") or false and check_ref(@TypeOf(MSISUsedValue), MSISUsedValue, 1, .@"="))) {
                        ...
                        switch (val) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                                ...
                                , .{
                                    ...
                                    "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz",
                                    if (patch_logs) @tagName(try val.to_enum()) else @tagName(val),
                    ...
                    if (config.extra_config.PWR_Regulator_Voltage_Scale) |val| {
                        if (val != .PWR_REGULATOR_VOLTAGE_SCALE1) {
                            ...
                            , .{
                                "PWR_Regulator_Voltage_Scale",
                                "(SYSCLKFreq_VALUE < 160000000) | (SYSCLKFreq_VALUE = 160000000)",
                                "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz",
                                patch_str,
                                val_enum,
                            });
            ...
            const HSE_VALUEValue: f32 = blk: {
                if ((config.flags.HSEByPass or config.flags.HSEDIGByPass) and scale4) {
                    ...
                    HSEOSC.limit = .{
                        .min = 0e0,
                        .max = 2.5e7,
                        .main_expr = "(HSEByPass  | HSEDIGByPass) & scale4",
            ...
            if (scale4 or config.flags.S_LPBAM_CONF) {
                USART1output.limit = .{
                    .min = null,
                    .max = 2.5e7,
                    .main_expr = "scale4|S_LPBAM_CONF",
                    .main_dialog = "",
                };
            } else if (scale1) {
                USART1output.limit = .{
            ...
            //======= HSPI1Freq_Value ========
            const HSPI1Freq_ValueValue = HSPIoutput.get_as_ref();
            ignore_value(HSPI1Freq_ValueValue);
            if (scale4 or config.flags.S_LPBAM_CONF) {
                HSPIoutput.limit = .{
                    .min = null,
                    .max = 2.5e7,
            ...
            //======= I2C5Freq_Value ========
            const I2C5Freq_ValueValue = I2C5output.get_as_ref();
            ignore_value(I2C5Freq_ValueValue);
            if (scale4 or config.flags.S_LPBAM_CONF) {
                I2C5output.limit = .{
                    .min = null,
                    .max = 2.5e7,
            ...
            //======= I2C6Freq_Value ========
            const I2C6Freq_ValueValue = I2C6output.get_as_ref();
            ignore_value(I2C6Freq_ValueValue);
            if (scale4 or config.flags.S_LPBAM_CONF) {
                I2C6output.limit = .{
                    .min = null,
                    .max = 2.5e7,
            ...
            if (OCTOSPIMSourcePLL1Q or OCTOSPIMSourcePLL2Q) {
                OCTOSPIMoutput.limit = .{
                    .min = null,
                    .max = 2e8,
                    .main_expr = "OCTOSPIMSourcePLL1Q|OCTOSPIMSourcePLL2Q",
                    .main_dialog = "",
                };
            } else if (scale4 or config.flags.S_LPBAM_CONF) {
                OCTOSPIMoutput.limit = .{
                    .min = null,
                    .max = 2.5e7,
                    .main_expr = "scale4|S_LPBAM_CONF",
            ...
            //======= USBPHYFreq_Value ========
            const USBPHYFreq_ValueValue = USBPHYoutput.get_as_ref();
            ...
            if (OCTOSPIMSourcePLL1Q and check_ref(@TypeOf(PLL1QUsedValue), PLL1QUsedValue, 1, .@"=")) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 2e8,
                    .main_expr = "OCTOSPIMSourcePLL1Q & PLL1QUsed=1",
                    .main_dialog = " ",
                };
            ...
            if (OCTOSPIMSourcePLL2Q and check_ref(@TypeOf(PLL2QUsedValue), PLL2QUsedValue, 1, .@"=")) {
                PLL2Qoutput.limit = .{
                    .min = null,
                    .max = 2e8,
                    .main_expr = "OCTOSPIMSourcePLL2Q & PLL2QUsed=1",
                    .main_dialog = " ",
                };
            ...
            if ((scale1 or scale2) and check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=")) {
                VCOOutput.limit = .{
                    .min = 1.28e8,
                    .max = 5.44e8,
                    .main_expr = "(scale1 | scale2) & PLLUsed=1",
                    .main_dialog = "",
                };
            } else if (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=")) {
                VCOOutput.limit = .{
            ...
            if ((scale1 or scale2) and check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=")) {
                VCOPLL2Output.limit = .{
                    .min = 1.28e8,
                    .max = 5.44e8,
                    .main_expr = "(scale1 | scale2) & PLL2Used=1",
                    .main_dialog = "PLL2Used=1 ",
                };
            ...
            if ((scale1 or scale2) and check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=")) {
                VCOPLL3Output.limit = .{
                    .min = 1.28e8,
                    .max = 5.44e8,
                    .main_expr = "(scale1 | scale2) & PLL3Used=1",
                    .main_dialog = " ",
                };
                ...
                if (config.flags.S_LPBAM_CONF) {
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_1) {
                            ...
                            , .{
                                "FLatency",
                                "(scale4 & ((HCLKFreq_Value < 25000000)|(HCLKFreq_Value= 25000000 )))",
                                "",
                                "FLASH_LATENCY_1",
                                val,
                            });
            ...
            if (!(check_ref(@TypeOf(EnableCRSValue), EnableCRSValue, .true, .@"=") or check_ref(@TypeOf(RNGEnableLPBAMValue), RNGEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(MCOEnableValue), MCOEnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"="))) {
                SHSIDiv.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"="))) {
                SAESMult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                SysClkSource.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                SysCLKOutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLLSource.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLL2Source.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLL3Source.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLLM.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))) {
                HSPIMult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))) {
                HSPIoutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
                LTDCMult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(I2C5EnableValue), I2C5EnableValue, .true, .@"="))) {
                I2C5Mult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(I2C5EnableValue), I2C5EnableValue, .true, .@"="))) {
                I2C5output.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(I2C6EnableValue), I2C6EnableValue, .true, .@"="))) {
                I2C6Mult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(I2C6EnableValue), I2C6EnableValue, .true, .@"="))) {
                I2C6output.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(MDF1EnableValue), MDF1EnableValue, .true, .@"="))) {
                MDF1Mult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(MDF1EnableValue), MDF1EnableValue, .true, .@"="))) {
                MDF1output.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(ADF1EnableValue), ADF1EnableValue, .true, .@"="))) {
                ADF1Mult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(ADF1EnableValue), ADF1EnableValue, .true, .@"="))) {
                ADF1output.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                AHBPrescaler.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                AHBOutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                HCLKOutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                FCLKCortexOutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB1Prescaler.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB1Output.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                TimPrescalerAPB1.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                TimPrescOut1.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB2Prescaler.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB2Output.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB3Prescaler.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                APB3Output.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                TimPrescalerAPB2.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                TimPrescOut2.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(USBPHYEnableHSEValue), USBPHYEnableHSEValue, .true, .@"="))) {
                HSEDiv2.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"="))) {
                PLL1PDiv2.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"="))) {
                USBPHYMult.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"="))) {
                USBPHYoutput.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLLFRACN.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBPHYEnablePllValue), USBPHYEnablePllValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(MDF1EnableLPBAMValue), MDF1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(ADF1EnableLPBAMValue), ADF1EnableLPBAMValue, .true, .@"="))) {
                PLL1P.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBPHYEnablePllValue), USBPHYEnablePllValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(MDF1EnableLPBAMValue), MDF1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(ADF1EnableLPBAMValue), ADF1EnableLPBAMValue, .true, .@"="))) {
                PLLPoutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(FDCANEnableLPBAMValue), FDCANEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableLPBAMValue), OCTOSPIMEnableLPBAMValue, .true, .@"="))) {
                PLL1Q.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(FDCANEnableLPBAMValue), FDCANEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableLPBAMValue), OCTOSPIMEnableLPBAMValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableValue), OCTOSPIMEnableValue, .true, .@"=") or check_ref(@TypeOf(FDCANEnableLPBAMValue), FDCANEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(ADCEnableLPBAMValue), ADCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(DACEnableLPBAMValue), DACEnableLPBAMValue, .true, .@"="))) {
                PLL2N.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLL2FRACN.nodetype = .off;
            }
            ...
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableLPBAMValue), OCTOSPIMEnableLPBAMValue, .true, .@"="))) {
                PLL2Q.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableLPBAMValue), OCTOSPIMEnableLPBAMValue, .true, .@"="))) {
                PLL2Qoutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(ADCEnableLPBAMValue), ADCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(DACEnableLPBAMValue), DACEnableLPBAMValue, .true, .@"="))) {
                PLL2R.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(ADCEnableLPBAMValue), ADCEnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(DACEnableLPBAMValue), DACEnableLPBAMValue, .true, .@"="))) {
                PLL2Routput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(MDF1EnableLPBAMValue), MDF1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(ADF1EnableLPBAMValue), ADF1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))) {
                PLL3N.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"="))) {
                PLL3FRACN.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"="))) {
                PLL3P.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))) {
                PLL3R.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))) {
            ...
            ignore_value(USART2Freq_ValueValue);
            ref_out.USART6CLockSelectionVirtual = USART6CLockSelectionVirtualValue;
            ignore_value(USART6Freq_ValueValue);
            ...
            ref_out.flags.HSPI1Enable = HSPI1EnableValue == .true;
            ...
            ref_out.flags.I2C5Enable = I2C5EnableValue == .true;
            ref_out.flags.I2C6Enable = I2C6EnableValue == .true;
            ...
            ref_out.flags.UCPD1Enable = UCPD1EnableValue == .true;
            ...
            ref_out.flags.USBPHYEnableHSE = USBPHYEnableHSEValue == .true;
            ref_out.flags.USBPHYEnable = USBPHYEnableValue == .true;
            ref_out.flags.EnableDSI = EnableDSIValue == .true;
            ref_out.flags.USBPHYEnablePll = USBPHYEnablePllValue == .true;
