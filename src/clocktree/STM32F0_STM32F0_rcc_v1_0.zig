    ...
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            const HSI48UsedValue: ?f32 = blk: {
                if ((((check_MCU("PLLSourceHSI48")) and (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"="))) or (check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_HSI48, .@"=")) or ((check_ref(@TypeOf(RCC_MCOSourceValue), RCC_MCOSourceValue, .RCC_MCO1SOURCE_HSI48, .@"=")) and ((check_MCU("SEM2RCC_MCO_REQUIRED_TIM14") and check_MCU("TIM14") and check_MCU("Semaphore_input_Channel1TIM14")) or config.flags.MCOConfig)) or (config.flags.USBUsed_ForRCC and !check_MCU("STM32F0x0_Value_Line") and (check_ref(@TypeOf(USBClockSelectionValue), USBClockSelectionValue, .RCC_USBCLKSOURCE_HSI48, .@"="))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
