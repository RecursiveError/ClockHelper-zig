...
pub const HSPICLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_HSPICLKSOURCE_SYSCLK => 0,
            .RCC_HSPICLKSOURCE_PLL1 => 1,
            .RCC_HSPICLKSOURCE_PLL2 => 2,
            .RCC_HSPICLKSOURCE_PLL3 => 3,
        };
    }
};
pub const LTDCCLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_LTDCCLKSOURCE_PLL2 => 0,
            .RCC_LTDCCLKSOURCE_PLL3 => 1,
        };
    }
};
...
pub const I2C5CLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_I2C5CLKSOURCE_PCLK1 => 0,
            .RCC_I2C5CLKSOURCE_SYSCLK => 1,
            .RCC_I2C5CLKSOURCE_HSI => 2,
            .RCC_I2C5CLKSOURCE_MSIK => 3,
        };
    }
};
pub const I2C6CLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_I2C6CLKSOURCE_PCLK1 => 0,
            .RCC_I2C6CLKSOURCE_SYSCLK => 1,
            .RCC_I2C6CLKSOURCE_HSI => 2,
            .RCC_I2C6CLKSOURCE_MSIK => 3,
        };
    }
};
...
pub const USBPHYCLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_USBPHYCLKSOURCE_HSE => 0,
            .RCC_USBPHYCLKSOURCE_HSE_DIV2 => 1,
            .RCC_USBPHYCLKSOURCE_PLL1 => 2,
            .RCC_USBPHYCLKSOURCE_PLL1_DIV2 => 3,
        };
    }
};
...
pub const HSPI1EnableList = enum {
    true,
    false,
};
...
pub const UCPD1EnableList = enum {
    true,
    false,
};
...
pub const USBPHYEnableHSEList = enum {
    true,
    false,
};
pub const USBPHYEnableList = enum {
    true,
    false,
};
...
pub const USBPHYEnablePllList = enum {
    true,
    false,
};
...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Config = struct {
            ...
            HSPICLockSelection: ?HSPICLockSelectionList = null,
            ...
            I2C6CLockSelection: ?I2C6CLockSelectionList = null,
            ...
            USBPHYCLockSelection: ?USBPHYCLockSelectionList = null,
        ...
        pub const Config_Output = struct {
            ...
            USART6CLockSelection: ?USART6CLockSelectionList = null, //from extra RCC references
            ...
            HSPICLockSelection: ?HSPICLockSelectionList = null, //from RCC Clock Config
            ...
            I2C6CLockSelection: ?I2C6CLockSelectionList = null, //from RCC Clock Config
            ...
            HSEDiv2: ?f32 = null, //from RCC Clock Config
            PLL1PDiv2: ?f32 = null, //from RCC Clock Config
            USBPHYCLockSelection: ?USBPHYCLockSelectionList = null, //from RCC Clock Config
            ...
            RNGEnableLPBAM: ?RNGEnableLPBAMList = null, //from extra RCC references
            MCOEnable: ?MCOEnableList = null, //from extra RCC references
            SDMMCEnableLPBAM: ?SDMMCEnableLPBAMList = null, //from extra RCC references
            EnableSAES: ?EnableSAESList = null, //from extra RCC references
            ...
            HSPI1Enable: ?HSPI1EnableList = null, //from extra RCC references
            ...
            I2C6Enable: ?I2C6EnableList = null, //from extra RCC references
            ...
            MDF1Enable: ?MDF1EnableList = null, //from extra RCC references
            ...
            UCPD1Enable: ?UCPD1EnableList = null, //from extra RCC references
            ...
            USBPHYEnableHSE: ?USBPHYEnableHSEList = null, //from extra RCC references
            USBPHYEnable: ?USBPHYEnableList = null, //from extra RCC references
            EnableDSI: ?EnableDSIList = null, //from extra RCC references
            USBPHYEnablePll: ?USBPHYEnablePllList = null, //from extra RCC references
            SAI1EnableLPBAM: ?SAI1EnableLPBAMList = null, //from extra RCC references
            SAI2EnableLPBAM: ?SAI2EnableLPBAMList = null, //from extra RCC references
            MDF1EnableLPBAM: ?MDF1EnableLPBAMList = null, //from extra RCC references
            ADF1EnableLPBAM: ?ADF1EnableLPBAMList = null, //from extra RCC references
            FDCANEnableLPBAM: ?FDCANEnableLPBAMList = null, //from extra RCC references
            OCTOSPIMEnableLPBAM: ?OCTOSPIMEnableLPBAMList = null, //from extra RCC references
            ADCEnableLPBAM: ?ADCEnableLPBAMList = null, //from extra RCC references
            DACEnableLPBAM: ?DACEnableLPBAMList = null, //from extra RCC references
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var HSPICLKSOURCE_PLL1: bool = false;
            var HSPICLKSOURCE_PLL2: bool = false;
            var HSPICLKSOURCE_PLL3: bool = false;
            var LTDCCLKSOURCE_PLL2: bool = false;
            var LTDCCLKSOURCE_PLL3: bool = false;
            ...
            var I2C5SourceHSI: bool = false;
            var I2C5CLKSOURCE_MSIK: bool = false;
            var I2C5SourceSys: bool = false;
            var I2C6SourceHSI: bool = false;
            var I2C6CLKSOURCE_MSIK: bool = false;
            var I2C6SourceSys: bool = false;
            ...
            var USBPHYCLKSOURCE_HSE_DIV2: bool = false;
            var USBPHYCLKSOURCE_PLL1: bool = false;
            var USBPHYCLKSOURCE_PLL1_DIV2: bool = false;
            var DSISourceisPLL3: bool = false;
            ...
            var WakeUpClockFreq_VALUELimit: Limit = .{};
            ...
            std.mem.doNotOptimizeAway(HSI48_VALUEValue);
            const SHSI_VALUEValue: ?f32 = blk: {
                break :blk 48000000;
            };

            std.mem.doNotOptimizeAway(SHSI_VALUEValue);
            const SHSIDivValue: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(SHSIDivValue);
            ...
            std.mem.doNotOptimizeAway(SAESSourceValue);
            ...
            std.mem.doNotOptimizeAway(MSIKClockRangeValue);
            ...
            const RCC_Stop_WakeUpClockValue: ?RCC_Stop_WakeUpClockList = blk: {
                ...
                break :blk conf_item orelse .RCC_STOP_WAKEUPCLOCK_MSI;
            };

            std.mem.doNotOptimizeAway(RCC_Stop_WakeUpClockValue);
            const WakeUpClockFreq_VALUEValue: ?f32 = blk: {
                WakeUpClockFreq_VALUELimit = .{
                    .min = null,
                    .max = 2.4e7,
                };
                break :blk null;
            ...
            std.mem.doNotOptimizeAway(WakeUpClockFreq_VALUEValue);
            ...
            const PLLSourceValue: ?PLLSourceList = blk: {
                if ((config.flags.USB_OTG_HS_Used or config.flags.OTG_HS_Used) and (USBPHYCLKSOURCE_PLL1 or USBPHYCLKSOURCE_PLL1_DIV2)) {
                    PLLSourceHSE = true;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\
                            , .{ "PLLSource", "(USB_OTG_HS_Used|OTG_HS_Used)&(USBPHYCLKSOURCE_PLL1|USBPHYCLKSOURCE_PLL1_DIV2)", "Only HSE is possible when OTG_HS is using PLL1", "RCC_PLLSOURCE_HSE", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(PLL2MValue);
            ...
            std.mem.doNotOptimizeAway(PLL3MValue);
            ...
            const USART1CLockSelectionValue: ?USART1CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_USART1CLKSOURCE_HSI;
            ...
            const USART2CLockSelectionValue: ?USART2CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_USART2CLKSOURCE_HSI;
                } else if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    const conf_item = config.USART2CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            const USART6CLockSelectionValue: ?USART6CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    USART6SourceHSI = true;
                    const item: USART6CLockSelectionList = .RCC_USART6CLKSOURCE_HSI;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "USART6CLockSelection", "S_LPBAM_CONF & (LSEOscillatorRTC|LSEByPassRTC)", "No Extra Log", "RCC_USART6CLKSOURCE_HSI", i });
                        }
                    }
                    break :blk item;
                } else if (check_MCU("S_LPBAM_CONF")) {
                        ...
                        switch (item) {
                            ...
                            .RCC_USART6CLKSOURCE_LSE => USART6SourceLSE = true,
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - RCC_USART6CLKSOURCE_HSI
                                    \\ - RCC_USART6CLKSOURCE_LSE
                                , .{ "USART6CLockSelection", "S_LPBAM_CONF", "No Extra Log", item });
                            },
                        }
                    }

                    break :blk conf_item orelse .RCC_USART6CLKSOURCE_HSI;
                } else if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    const conf_item = config.USART6CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
                            .RCC_USART6CLKSOURCE_PCLK1 => USART6SourcePCLK1 = true,
                            ...
                            .RCC_USART6CLKSOURCE_HSI => USART6SourceHSI = true,
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - RCC_USART6CLKSOURCE_SYSCLK
                                    \\ - RCC_USART6CLKSOURCE_HSI
                                , .{ "USART6CLockSelection", "(LSEOscillatorRTC|LSEByPassRTC)", "LSE is configured only for RTC", item });
                            },
                        }
                    }
            ...
            std.mem.doNotOptimizeAway(USART6CLockSelectionValue);
            ...
            const USART3CLockSelectionValue: ?USART3CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_USART3CLKSOURCE_HSI;
                } else if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    const conf_item = config.USART3CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            std.mem.doNotOptimizeAway(USART3CLockSelectionValue);
            ...
            const UART4CLockSelectionValue: ?UART4CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_UART4CLKSOURCE_HSI;
                } else if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    const conf_item = config.UART4CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            std.mem.doNotOptimizeAway(UART4CLockSelectionValue);
            ...
            const UART5CLockSelectionValue: ?UART5CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_UART5CLKSOURCE_HSI;
                } else if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    const conf_item = config.UART5CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            std.mem.doNotOptimizeAway(UART5CLockSelectionValue);
            ...
            const LPUART1CLockSelectionValue: ?LPUART1CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_LPUART1CLKSOURCE_HSI;
                } else if (check_MCU("S_LPBAM_CONF")) {
                    const conf_item = config.LPUART1CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            const HSPICLockSelectionValue: ?HSPICLockSelectionList = blk: {
                const conf_item = config.HSPICLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_HSPICLKSOURCE_SYSCLK => {},
                        .RCC_HSPICLKSOURCE_PLL1 => HSPICLKSOURCE_PLL1 = true,
                        .RCC_HSPICLKSOURCE_PLL2 => HSPICLKSOURCE_PLL2 = true,
                        .RCC_HSPICLKSOURCE_PLL3 => HSPICLKSOURCE_PLL3 = true,
                    }
                }

                break :blk conf_item orelse .RCC_HSPICLKSOURCE_SYSCLK;
            };

            std.mem.doNotOptimizeAway(HSPICLockSelectionValue);
            const HSPI1Freq_ValueValue: ?f32 = blk: {
                if (scale4 or check_MCU("S_LPBAM_CONF")) {
                    HSPI1Freq_ValueLimit = .{
                        .min = null,
                        .max = 2.5e7,
                    };
                    break :blk null;
            ...
            std.mem.doNotOptimizeAway(HSPI1Freq_ValueValue);
            const LTDCCLockSelectionValue: ?LTDCCLockSelectionList = blk: {
                const conf_item = config.LTDCCLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_LTDCCLKSOURCE_PLL2 => LTDCCLKSOURCE_PLL2 = true,
                        .RCC_LTDCCLKSOURCE_PLL3 => LTDCCLKSOURCE_PLL3 = true,
                    }
                }

                break :blk conf_item orelse .RCC_LTDCCLKSOURCE_PLL2;
            };

            std.mem.doNotOptimizeAway(LTDCCLockSelectionValue);
            ...
            const LPTIM1CLockSelectionValue: ?LPTIM1CLockSelectionList = blk: {
                if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_LPTIM1CLKSOURCE_MSIK;
                }
                const conf_item = config.LPTIM1CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            const LPTIM2CLockSelectionValue: ?LPTIM2CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF") and (config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_LPTIM2CLKSOURCE_HSI;
                } else if (check_MCU("S_LPBAM_CONF")) {
                    const conf_item = config.LPTIM2CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
            ...
            const DACCLockSelectionValue: ?DACCLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_DAC1CLKSOURCE_LSI;
            };

            std.mem.doNotOptimizeAway(DACCLockSelectionValue);
            ...
            const ADCCLockSelectionValue: ?ADCCLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk conf_item orelse .RCC_ADCDACCLKSOURCE_HSI;
                }
                const conf_item = config.ADCCLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            const CK48CLockSelectionValue: ?CK48CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    const item: CK48CLockSelectionList = .RCC_CLK48CLKSOURCE_MSIK;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "CK48CLockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_CLK48CLKSOURCE_MSIK", i });
                        }
                    }
                    break :blk item;
                }
                ...
                break :blk conf_item orelse .RCC_CLK48CLKSOURCE_HSI48;
            };

            std.mem.doNotOptimizeAway(CK48CLockSelectionValue);
            const CK48Freq_ValueValue: ?f32 = blk: {
                if (scale4 or check_MCU("S_LPBAM_CONF")) {
                    CK48Freq_ValueLimit = .{
                        .min = null,
                        .max = 2.5e7,
            ...
            std.mem.doNotOptimizeAway(CK48Freq_ValueValue);
            const SDMMCClockSelectionValue: ?SDMMCClockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    SDMMC1SourceIsClock48 = true;
                    const item: SDMMCClockSelectionList = .RCC_SDMMCCLKSOURCE_CLK48;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "SDMMCClockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_SDMMCCLKSOURCE_CLK48", i });
                        }
                    }
                    break :blk item;
                }
                ...
                break :blk conf_item orelse .RCC_SDMMCCLKSOURCE_PLL1;
            };

            std.mem.doNotOptimizeAway(SDMMCClockSelectionValue);
            ...
            const FDCANClockSelectionValue: ?FDCANClockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_FDCAN1CLKSOURCE_PLL1;
            };

            std.mem.doNotOptimizeAway(FDCANClockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(I2C2CLockSelectionValue);
            ...
            const I2C5CLockSelectionValue: ?I2C5CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    if (conf_item) |item| {
                        switch (item) {
                            .RCC_I2C5CLKSOURCE_HSI => I2C5SourceHSI = true,
                            .RCC_I2C5CLKSOURCE_MSIK => I2C5CLKSOURCE_MSIK = true,
                            else => {
                                try comptime_fail_or_error(error.InvalidConfig,
                                    \\
                                    \\Error on {s} | expr: {s} diagnostic: {s} 
                                    ...
                                    \\ - RCC_I2C5CLKSOURCE_HSI
                                    \\ - RCC_I2C5CLKSOURCE_MSIK
                                , .{ "I2C5CLockSelection", "S_LPBAM_CONF", "No Extra Log", item });
                            },
                        }
                    }

                    break :blk conf_item orelse .RCC_I2C5CLKSOURCE_HSI;
                }
                const conf_item = config.I2C5CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_I2C5CLKSOURCE_PCLK1 => {},
                        .RCC_I2C5CLKSOURCE_SYSCLK => I2C5SourceSys = true,
                        .RCC_I2C5CLKSOURCE_HSI => I2C5SourceHSI = true,
                        .RCC_I2C5CLKSOURCE_MSIK => I2C5CLKSOURCE_MSIK = true,
                    }
                }

                break :blk conf_item orelse .RCC_I2C5CLKSOURCE_PCLK1;
            };

            std.mem.doNotOptimizeAway(I2C5CLockSelectionValue);
            ...
            const I2C6CLockSelectionValue: ?I2C6CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    const conf_item = config.I2C6CLockSelection;
                    if (conf_item) |item| {
                        switch (item) {
                            .RCC_I2C6CLKSOURCE_HSI => I2C6SourceHSI = true,
                            .RCC_I2C6CLKSOURCE_MSIK => I2C6CLKSOURCE_MSIK = true,
                            else => {
                                try comptime_fail_or_error(error.InvalidConfig,
                                    \\
                                    \\Error on {s} | expr: {s} diagnostic: {s} 
                                    ...
                                    \\ - RCC_I2C6CLKSOURCE_HSI
                                    \\ - RCC_I2C6CLKSOURCE_MSIK
                                , .{ "I2C6CLockSelection", "S_LPBAM_CONF", "No Extra Log", item });
                            },
                        }
                    }

                    break :blk conf_item orelse .RCC_I2C6CLKSOURCE_HSI;
                }
                const conf_item = config.I2C6CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_I2C6CLKSOURCE_PCLK1 => {},
                        .RCC_I2C6CLKSOURCE_SYSCLK => I2C6SourceSys = true,
                        .RCC_I2C6CLKSOURCE_HSI => I2C6SourceHSI = true,
                        .RCC_I2C6CLKSOURCE_MSIK => I2C6CLKSOURCE_MSIK = true,
                    }
                }

                break :blk conf_item orelse .RCC_I2C6CLKSOURCE_PCLK1;
            };

            std.mem.doNotOptimizeAway(I2C6CLockSelectionValue);
            const I2C6Freq_ValueValue: ?f32 = blk: {
                if (scale4 or check_MCU("S_LPBAM_CONF")) {
                    I2C6Freq_ValueLimit = .{
                        .min = null,
                        .max = 2.5e7,
            ...
            std.mem.doNotOptimizeAway(I2C6Freq_ValueValue);
            ...
            const SAI1CLockSelectionValue: ?SAI1CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    SAI1SourceHSI = true;
                    const item: SAI1CLockSelectionList = .RCC_SAI1CLKSOURCE_HSI;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "SAI1CLockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_SAI1CLKSOURCE_HSI", i });
                        }
                    }
                    break :blk item;
                }
                ...
                break :blk conf_item orelse .RCC_SAI1CLKSOURCE_PLL2;
            };
            ...
            const SAI2CLockSelectionValue: ?SAI2CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    SAI2SourceHSI = true;
                    const item: SAI2CLockSelectionList = .RCC_SAI2CLKSOURCE_HSI;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "SAI2CLockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_SAI2CLKSOURCE_HSI", i });
                        }
                    }
                    break :blk item;
                }
                ...
                break :blk conf_item orelse .RCC_SAI2CLKSOURCE_PLL2;
            };

            std.mem.doNotOptimizeAway(SAI2CLockSelectionValue);
            ...
            const I2C4CLockSelectionValue: ?I2C4CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk conf_item orelse .RCC_I2C4CLKSOURCE_HSI;
                }
                const conf_item = config.I2C4CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            std.mem.doNotOptimizeAway(I2C4CLockSelectionValue);
            ...
            const MdfClockSelectionValue: ?MdfClockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    const item: MdfClockSelectionList = .RCC_MDF1CLKSOURCE_MSIK;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "MdfClockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_MDF1CLKSOURCE_MSIK", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(MdfClockSelectionValue);
            const MDF1Freq_ValueValue: ?f32 = blk: {
                if (scale4 or check_MCU("S_LPBAM_CONF")) {
                    MDF1Freq_ValueLimit = .{
                        .min = null,
                        .max = 2.5e7,
            ...
            std.mem.doNotOptimizeAway(MDF1Freq_ValueValue);
            const AdfClockSelectionValue: ?AdfClockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ADF1CLKSOURCE_MSIK = true;
                    const item: AdfClockSelectionList = .RCC_ADF1CLKSOURCE_MSIK;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "AdfClockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_ADF1CLKSOURCE_MSIK", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(AdfClockSelectionValue);
            ...
            const OCTOSPIMCLockSelectionValue: ?OCTOSPIMCLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    const item: OCTOSPIMCLockSelectionList = .RCC_OSPICLKSOURCE_MSIK;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "OCTOSPIMCLockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_OSPICLKSOURCE_MSIK", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(OCTOSPIMCLockSelectionValue);
            ...
            const LPTIM3CLockSelectionValue: ?LPTIM3CLockSelectionList = blk: {
                if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .RCC_LPTIM34CLKSOURCE_MSIK;
                }
                const conf_item = config.LPTIM3CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            std.mem.doNotOptimizeAway(LPTIM3CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(HSI48DivToRNGValue);
            const RNGCLockSelectionValue: ?RNGCLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    RNGCLKSOURCE_HSI = true;
                    const item: RNGCLockSelectionList = .RCC_RNGCLKSOURCE_HSI;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "RNGCLockSelection", "S_LPBAM_CONF", "No Extra Log", "RCC_RNGCLKSOURCE_HSI", i });
                        }
                    }
                    break :blk item;
                }
            ...
            const CortexCLockSelectionValue: ?CortexCLockSelectionList = blk: {
                if ((config.flags.LSEOscillatorRTC or config.flags.LSEByPassRTC)) {
                    ...
                    break :blk conf_item orelse .SYSTICK_CLKSOURCE_HCLK_1_8;
                }
                const conf_item = config.CortexCLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            std.mem.doNotOptimizeAway(APB3CLKDividerValue);
            ...
            const SPI1CLockSelectionValue: ?SPI1CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk conf_item orelse .RCC_SPI1CLKSOURCE_HSI;
                }
                const conf_item = config.SPI1CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            const SPI3CLockSelectionValue: ?SPI3CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk conf_item orelse .RCC_SPI3CLKSOURCE_HSI;
                }
                const conf_item = config.SPI3CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            const SPI2CLockSelectionValue: ?SPI2CLockSelectionList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk conf_item orelse .RCC_SPI2CLKSOURCE_HSI;
                }
                const conf_item = config.SPI2CLockSelection;
                if (conf_item) |item| {
                    switch (item) {
            ...
            std.mem.doNotOptimizeAway(SPI2CLockSelectionValue);
            ...
            const HSEDiv2Value: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(HSEDiv2Value);
            const PLL1PDiv2Value: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(PLL1PDiv2Value);
            const USBPHYCLockSelectionValue: ?USBPHYCLockSelectionList = blk: {
                const conf_item = config.USBPHYCLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_USBPHYCLKSOURCE_HSE => USBPHYCLKSOURCE_HSE = true,
                        .RCC_USBPHYCLKSOURCE_HSE_DIV2 => USBPHYCLKSOURCE_HSE_DIV2 = true,
                        .RCC_USBPHYCLKSOURCE_PLL1 => USBPHYCLKSOURCE_PLL1 = true,
                        .RCC_USBPHYCLKSOURCE_PLL1_DIV2 => USBPHYCLKSOURCE_PLL1_DIV2 = true,
                    }
                }

                break :blk conf_item orelse .RCC_USBPHYCLKSOURCE_PLL1;
            };

            std.mem.doNotOptimizeAway(USBPHYCLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(DSICLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(DSITX_DivValue);
            ...
            const PLL1QUsedValue: ?f32 = blk: {
                if (config.flags.HSPI1_Used and HSPICLKSOURCE_PLL1 or ((config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC) and OCTOSPIMSourcePLL1Q) or FDCANSourcePLL1Q and config.flags.FDCAN1Used_ForRCC or (CK48SourcePLL1Q and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            std.mem.doNotOptimizeAway(PLL2NValue);
            ...
            std.mem.doNotOptimizeAway(PLL2FRACNValue);
            ...
            std.mem.doNotOptimizeAway(PLL2PValue);
            ...
            std.mem.doNotOptimizeAway(PLL2PUsedValue);
            ...
            std.mem.doNotOptimizeAway(PLL2QValue);
            const PLL2QUsedValue: ?f32 = blk: {
                if (HSPICLKSOURCE_PLL2 and config.flags.HSPI1_Used or (config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC) and OCTOSPIMSourcePLL2Q or (CK48SourcePLL2Q and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) {
                    break :blk 1;
                }
                break :blk 0;
            };

            std.mem.doNotOptimizeAway(PLL2QUsedValue);
            ...
            std.mem.doNotOptimizeAway(PLL2RValue);
            const PLL2RUsedValue: ?f32 = blk: {
                if (LTDCCLKSOURCE_PLL2 and config.flags.LTDC_Used or (ADCSourcePLL2R and check_MCU("DAC1")) or (ADCSourcePLL2R and ((config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC2 and config.flags.ADCUsed_ForRCC) or (config.flags.USE_ADC4 and config.flags.ADCUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };

            std.mem.doNotOptimizeAway(PLL2RUsedValue);
            ...
            std.mem.doNotOptimizeAway(PLL3NValue);
            ...
            std.mem.doNotOptimizeAway(PLL3FRACNValue);
            ...
            std.mem.doNotOptimizeAway(PLL3PValue);
            const PLL3PUsedValue: ?f32 = blk: {
                if (DSISourceisPLL3 and config.flags.DSIHOST_Used or ((SAI1SourcePLL3P and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC)) or (SAI2SourcePLL3P and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };

            std.mem.doNotOptimizeAway(PLL3PUsedValue);
            ...
            std.mem.doNotOptimizeAway(PLL3QValue);
            ...
            std.mem.doNotOptimizeAway(PLL3QUsedValue);
            ...
            std.mem.doNotOptimizeAway(PLL3RValue);
            ...
            std.mem.doNotOptimizeAway(PLLDSIIDFValue);
            const PLLDSIMultValue: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(PLLDSIMultValue);
            ...
            std.mem.doNotOptimizeAway(PLLDSINDIVValue);
            ...
            std.mem.doNotOptimizeAway(PLLDSIODFValue);
            ...
            const FLatencyValue: ?FLatencyList = blk: {
                ...
                } else if ((scale4 and ((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 25000000, .@"<")) or (check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 25000000, .@"="))))) {
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale4 & ((HCLKFreq_Value < 25000000)|(HCLKFreq_Value= 25000000 )))", "No Extra Log", "FLASH_LATENCY_1", i });
                        }
                    }
                    break :blk item;
            ...
            std.mem.doNotOptimizeAway(MSICalibrationValueValue);
            ...
            std.mem.doNotOptimizeAway(PLL2UsedValue);
            const PLL3RUsedValue: ?f32 = blk: {
                if ((HSPICLKSOURCE_PLL3 and config.flags.HSPI1_Used) or (LTDCCLKSOURCE_PLL3 and config.flags.LTDC_Used)) {
                    break :blk 1;
                }
                break :blk 0;
            };

            std.mem.doNotOptimizeAway(PLL3RUsedValue);
            ...
            std.mem.doNotOptimizeAway(MSISUsedValue);
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if (check_MCU("S_LPBAM_CONF")) {
                    ...
                    break :blk null;
                } else if (((check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 25000000, .@"<")) or (check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 25000000, .@"="))) and !(check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=") or check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=") or check_ref(@TypeOf(FullHSI48UsedValue), FullHSI48UsedValue, 1, .@"=") or MSIK48 and check_ref(@TypeOf(MSIKUsedValue), MSIKUsedValue, 1, .@"=") or MSIS48 and check_ref(@TypeOf(MSISUsedValue), MSISUsedValue, 1, .@"="))) {
                    ...
                    break :blk conf_item orelse .PWR_REGULATOR_VOLTAGE_SCALE4;
                        ...
                        switch (item) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE2
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE1
                                , .{ "PWR_Regulator_Voltage_Scale", "((SYSCLKFreq_VALUE <55000000) | (SYSCLKFreq_VALUE =55000000))", "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz", item });
                            },
                        }
                    }
                        ...
                        switch (item) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE2
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE1
                                , .{ "PWR_Regulator_Voltage_Scale", "(SYSCLKFreq_VALUE < 110000000) | (SYSCLKFreq_VALUE = 110000000)", "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz", item });
                            },
                        }
                    }

                    break :blk conf_item orelse .PWR_REGULATOR_VOLTAGE_SCALE2;
                } else if ((check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 160000000, .@"<")) or (check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 160000000, .@"="))) {
                    scale1 = true;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "PWR_Regulator_Voltage_Scale", "(SYSCLKFreq_VALUE < 160000000) | (SYSCLKFreq_VALUE = 160000000)", "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz", "PWR_REGULATOR_VOLTAGE_SCALE1", i });
                        }
                    }
                    break :blk item;
                } else if ((check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 160000000, .@">"))) {
                    scale1 = true;
                    const item: PWR_Regulator_Voltage_ScaleList = .PWR_REGULATOR_VOLTAGE_SCALE1;
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "PWR_Regulator_Voltage_Scale", "(SYSCLKFreq_VALUE > 160000000)", "Range 4 is not allowed when using PLLs, HSI48 not divided by 2 or MSIK/MSIS having 48 MHz", "PWR_REGULATOR_VOLTAGE_SCALE1", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(LSEStateValue);
            const MSIAutoCalibrationValue: ?MSIAutoCalibrationList = blk: {
                if ((check_ref(@TypeOf(LSEStateValue), LSEStateValue, .RCC_LSE_OFF, .@"=")) and (((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL1Q and PLLSourceMSI) or ((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL2Q and PLL2SourceMSI))) {
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "MSIAutoCalibration", "(LSEState=RCC_LSE_OFF) & (((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL1Q&PLLSourceMSI)|((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL2Q&PLL2SourceMSI))", "No Extra Log", "PLLMODE_MSIS", i });
                        }
                    }
                    break :blk item;
                } else if ((((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL1Q and PLLSourceMSI) or ((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CK48SourcePLL2Q and PLL2SourceMSI))) {
                    MSIAutoCalibrationON = true;
                    const item: MSIAutoCalibrationList = .PLLMODE_MSIS;
                    const conf_item = config.extra.MSIAutoCalibration;
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "MSIAutoCalibration", "(((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL1Q&PLLSourceMSI)|((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))&CK48SourcePLL2Q&PLL2SourceMSI))", "No Extra Log", "PLLMODE_MSIS", i });
                        }
                    }
                    break :blk item;
                } else if ((check_ref(@TypeOf(LSEStateValue), LSEStateValue, .RCC_LSE_OFF, .@"=")) and ((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CLK48CLKSOURCE_MSIK)) {
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "MSIAutoCalibration", "(LSEState=RCC_LSE_OFF) & ((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)) & CLK48CLKSOURCE_MSIK)", "No Extra Log", "PLLMODE_MSIK", i });
                        }
                    }
                    break :blk item;
                } else if (((SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) and CLK48CLKSOURCE_MSIK)) {
                    MSIKAutoCalibrationON = true;
                    const item: MSIAutoCalibrationList = .PLLMODE_MSIK;
                    const conf_item = config.extra.MSIAutoCalibration;
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "MSIAutoCalibration", "((SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)) & CLK48CLKSOURCE_MSIK)", "No Extra Log", "PLLMODE_MSIK", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(MSIAutoCalibrationValue);
            ...
            std.mem.doNotOptimizeAway(MSIPLLFASTValue);
            const PrescalerValue: ?PrescalerList = blk: {
                if (!config.flags.CRSActivatedSourceGPIO and !config.flags.CRSActivatedSourceLSE and !check_MCU("CRSActivatedSourceUSB")) {
            ...
            std.mem.doNotOptimizeAway(PrescalerValue);
            ...
            std.mem.doNotOptimizeAway(SourceValue);
            ...
            std.mem.doNotOptimizeAway(PolarityValue);
            ...
            std.mem.doNotOptimizeAway(ReloadValueTypeValue);
            const ReloadValueValue: ?f32 = blk: {
                if (!config.flags.CRSActivatedSourceGPIO and !config.flags.CRSActivatedSourceLSE and !check_MCU("CRSActivatedSourceUSB")) {
                    ...
                    break :blk null;
                } else if (!config.flags.CRSActivatedSourceGPIO and !config.flags.CRSActivatedSourceLSE and !check_MCU("CRSActivatedSourceUSB")) {
                    if (config.extra.ReloadValue) |_| {
                        try comptime_fail_or_error(error.InvalidConfig,
                            \\
                            \\Error on {s} | expr: {s} diagnostic: {s} 
            ...
            std.mem.doNotOptimizeAway(ReloadValueValue);
            ...
            std.mem.doNotOptimizeAway(FsyncValue);
            ...
            std.mem.doNotOptimizeAway(ErrorLimitValueValue);
            ...
            std.mem.doNotOptimizeAway(HSI48CalibrationValueValue);
            ...
            std.mem.doNotOptimizeAway(PLL1MBOOSTValue);
            const VCOInputFreq_ValueValue: ?f32 = blk: {
                ...
                if (config.VCOInputFreq_Value) |val| {
                    if (val != 4e6) {
                        try comptime_fail_or_error(error.InvalidConfig,
                            \\
                            \\Error on {s} | expr: {s} diagnostic: {s} 
            ...
            std.mem.doNotOptimizeAway(PLL2_VCI_RangeValue);
            ...
            std.mem.doNotOptimizeAway(PLL3_VCI_RangeValue);
            ...
            std.mem.doNotOptimizeAway(MSIKERONValue);
            ...
            std.mem.doNotOptimizeAway(HSIKERONValue);
            const EnableCRSValue: ?EnableCRSList = blk: {
                if (config.flags.CRSActivatedSourceGPIO or config.flags.CRSActivatedSourceLSE or check_MCU("CRSActivatedSourceUSB")) {
            ...
            std.mem.doNotOptimizeAway(EnableCRSValue);
            ...
            std.mem.doNotOptimizeAway(RNGEnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(SDMMCEnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(EnableSAESValue);
            ...
            std.mem.doNotOptimizeAway(notInLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(EnableHSELCDDevisorValue);
            ...
            std.mem.doNotOptimizeAway(LCDEnableValue);
            ...
            std.mem.doNotOptimizeAway(USART6EnableValue);
            ...
            std.mem.doNotOptimizeAway(USART3EnableValue);
            ...
            std.mem.doNotOptimizeAway(UART4EnableValue);
            ...
            std.mem.doNotOptimizeAway(UART5EnableValue);
            ...
            const HSPI1EnableValue: ?HSPI1EnableList = blk: {
                if (config.flags.HSPI1_Used) {
                    const item: HSPI1EnableList = .true;
                    break :blk item;
                }
                const item: HSPI1EnableList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(HSPI1EnableValue);
            ...
            std.mem.doNotOptimizeAway(LTDCEnableValue);
            ...
            std.mem.doNotOptimizeAway(DACEnableValue);
            ...
            std.mem.doNotOptimizeAway(SDMMCEnableValue);
            ...
            std.mem.doNotOptimizeAway(FDCANEnableValue);
            ...
            std.mem.doNotOptimizeAway(I2C2EnableValue);
            ...
            std.mem.doNotOptimizeAway(I2C5EnableValue);
            const I2C6EnableValue: ?I2C6EnableList = blk: {
                if (config.flags.I2C6Used_ForRCC) {
                    const item: I2C6EnableList = .true;
                    break :blk item;
                }
                const item: I2C6EnableList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(I2C6EnableValue);
            ...
            std.mem.doNotOptimizeAway(SAI2EnableValue);
            ...
            std.mem.doNotOptimizeAway(I2C4EnableValue);
            ...
            std.mem.doNotOptimizeAway(MDF1EnableValue);
            ...
            std.mem.doNotOptimizeAway(ADF1EnableValue);
            const OCTOSPIMEnableValue: ?OCTOSPIMEnableList = blk: {
                if (config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC) {
                    ...
                    break :blk item;
                } else if ((config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC)) {
                    const item: OCTOSPIMEnableList = .true;
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(OCTOSPIMEnableValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM3EnableValue);
            ...
            const UCPD1EnableValue: ?UCPD1EnableList = blk: {
                if ((config.flags.UCPD1_Used)) {
                    const item: UCPD1EnableList = .true;
                    break :blk item;
                }
                const item: UCPD1EnableList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(UCPD1EnableValue);
            ...
            std.mem.doNotOptimizeAway(SPI2EnableValue);
            const USBPHYEnableHSEValue: ?USBPHYEnableHSEList = blk: {
                if ((config.flags.USB_OTG_HS_Used or config.flags.OTG_HS_Used) and (config.flags.HSEOscillator or config.flags.HSEByPass or config.flags.HSEDIGByPass)) {
                    const item: USBPHYEnableHSEList = .true;
                    break :blk item;
                }
                const item: USBPHYEnableHSEList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(USBPHYEnableHSEValue);
            const USBPHYEnableValue: ?USBPHYEnableList = blk: {
                if (config.flags.USB_OTG_HS_Used or config.flags.OTG_HS_Used) {
                    const item: USBPHYEnableList = .true;
                    break :blk item;
                }
                const item: USBPHYEnableList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(USBPHYEnableValue);
            ...
            std.mem.doNotOptimizeAway(EnableDSIValue);
            const USBPHYEnablePllValue: ?USBPHYEnablePllList = blk: {
                if (config.flags.USB_OTG_HS_Used or config.flags.OTG_HS_Used) {
                    const item: USBPHYEnablePllList = .true;
                    break :blk item;
                }
                const item: USBPHYEnablePllList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(USBPHYEnablePllValue);
            ...
            std.mem.doNotOptimizeAway(SAI1EnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(SAI2EnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(MDF1EnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(ADF1EnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(FDCANEnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(OCTOSPIMEnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(ADCEnableLPBAMValue);
            ...
            std.mem.doNotOptimizeAway(DACEnableLPBAMValue);
            ...
            var HSPIMult = ClockNode{
                .name = "HSPIMult",
                .nodetype = .off,
                .parents = &.{},
            };

            var HSPIoutput = ClockNode{
                .name = "HSPIoutput",
                .nodetype = .off,
                .parents = &.{},
            };
            ...
            var I2C6Mult = ClockNode{
                .name = "I2C6Mult",
                .nodetype = .off,
                .parents = &.{},
            };

            var I2C6output = ClockNode{
                .name = "I2C6output",
                .nodetype = .off,
                .parents = &.{},
            };
            ...
            var PLL1PDiv2 = ClockNode{
                .name = "PLL1PDiv2",
                .nodetype = .off,
                .parents = &.{},
            };

            var USBPHYMult = ClockNode{
                .name = "USBPHYMult",
                .nodetype = .off,
                .parents = &.{},
            };

            var USBPHYoutput = ClockNode{
                .name = "USBPHYoutput",
                .nodetype = .off,
                .parents = &.{},
            };
            ...
            if (!check_MCU("S_LPBAM_CONF")) {
                if (check_ref(@TypeOf(EnableCRSValue), EnableCRSValue, .true, .@"=") or
                    ...
                    check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"="))
                {
            ...
            if (check_MCU("SAES_Exist")) {
                if (check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"=")) {
                    const SHSIRC_clk_value = SHSI_VALUEValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("SAES_Exist")) {
                if (check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"=")) {
                    const SHSIDiv_clk_value = SHSIDivValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("SAES_Exist")) {
                if (check_ref(@TypeOf(EnableSAESValue), EnableSAESValue, .true, .@"=")) {
                    const SAESMult_clk_value = SAESSourceValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const LSIDIV_clk_value = LSIDIVValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const MSIKRC_clk_value = MSIKClockRangeValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("S_LPBAM_CONF")) {
                const RCC_Stop_WakeUpClock_clk_value = RCC_Stop_WakeUpClockValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("S_LPBAM_CONF")) {
                WakeUpClockOutput.limit = WakeUpClockFreq_VALUELimit;
            ...
            if (check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"=")) {
                const PLL2M_clk_value = PLL2MValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"=")) {
                const PLL3M_clk_value = PLL3MValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("HSPI1_Exist")) {
                if (check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=")) {
                    const HSPIMult_clk_value = HSPICLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    ...
                    const HSPIMultparents = [_]*const ClockNode{
                        &SysCLKOutput,
                        &PLL1Q,
                        &PLL2Q,
                        &PLL3R,
                    };
                    HSPIMult.nodetype = .multi;
                    HSPIMult.parents = &.{HSPIMultparents[HSPIMult_clk_value.get()]};
                }
            }
            if (check_MCU("HSPI1_Exist")) {
                if (check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=")) {
                    HSPIoutput.limit = HSPI1Freq_ValueLimit;
                    HSPIoutput.nodetype = .output;
                    HSPIoutput.parents = &.{&HSPIMult};
                }
            }
            ...
            if (check_ref(@TypeOf(DACEnableValue), DACEnableValue, .true, .@"=")) {
                const DACMult_clk_value = DACCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("SDMMC1_Exist") or check_MCU("SDMMC2_Exist")) {
                if (check_ref(@TypeOf(SDMMCEnableValue), SDMMCEnableValue, .true, .@"=")) {
                    CK48output.limit = CK48Freq_ValueLimit;
            ...
            if (check_MCU("I2C5_Exist")) {
                if (check_ref(@TypeOf(I2C5EnableValue), I2C5EnableValue, .true, .@"=")) {
                    const I2C5Mult_clk_value = I2C5CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("I2C6_Exist")) {
                if (check_ref(@TypeOf(I2C6EnableValue), I2C6EnableValue, .true, .@"=")) {
                    const I2C6Mult_clk_value = I2C6CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    ...
                    const I2C6Multparents = [_]*const ClockNode{
                        &APB1Prescaler,
                        &SysCLKOutput,
                        &HSIRC,
                        &MSIKRC,
                    };
                    I2C6Mult.nodetype = .multi;
                    I2C6Mult.parents = &.{I2C6Multparents[I2C6Mult_clk_value.get()]};
                }
            }
            if (check_MCU("I2C6_Exist")) {
                if (check_ref(@TypeOf(I2C6EnableValue), I2C6EnableValue, .true, .@"=")) {
                    I2C6output.limit = I2C6Freq_ValueLimit;
                    I2C6output.nodetype = .output;
                    I2C6output.parents = &.{&I2C6Mult};
                }
            }
            ...
            if (check_ref(@TypeOf(MDF1EnableValue), MDF1EnableValue, .true, .@"=")) {
                const MDF1Mult_clk_value = MdfClockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(MDF1EnableValue), MDF1EnableValue, .true, .@"=")) {
                MDF1output.limit = MDF1Freq_ValueLimit;
                MDF1output.nodetype = .output;
                MDF1output.parents = &.{&MDF1Mult};
            }
            if (check_ref(@TypeOf(ADF1EnableValue), ADF1EnableValue, .true, .@"=")) {
                const ADF1Mult_clk_value = AdfClockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(RNGEnableLPBAMValue), RNGEnableLPBAMValue, .true, .@"=")) {
                const HSI48DivToRNG_clk_value = HSI48DivToRNGValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"=")) {
                const CortexCLockSelection_clk_value = CortexCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"=")) {
                const APB3Prescaler_clk_value = APB3CLKDividerValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(UCPD1EnableValue), UCPD1EnableValue, .true, .@"=")) {
            ...
            if (check_ref(@TypeOf(USBPHYEnableHSEValue), USBPHYEnableHSEValue, .true, .@"=")) {
                const HSEDiv2_clk_value = HSEDiv2Value orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                ...
                HSEDiv2.value = HSEDiv2_clk_value;
                HSEDiv2.parents = &.{&HSEOSC};
            }
            if (check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"=")) {
                const PLL1PDiv2_clk_value = PLL1PDiv2Value orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                ...
                PLL1PDiv2.nodetype = .div;
                PLL1PDiv2.value = PLL1PDiv2_clk_value;
                PLL1PDiv2.parents = &.{&PLL1P};
            }
            if (check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"=")) {
                const USBPHYMult_clk_value = USBPHYCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                , .{
                    ...
                    "Else",
                    "No Extra Log",
                    "USBPHYCLockSelection",
                });
                const USBPHYMultparents = [_]*const ClockNode{
                    &HSEOSC,
                    &HSEDiv2,
                    &PLL1P,
                    &PLL1PDiv2,
                };
                USBPHYMult.nodetype = .multi;
                USBPHYMult.parents = &.{USBPHYMultparents[USBPHYMult_clk_value.get()]};
            }
            if (check_ref(@TypeOf(USBPHYEnableValue), USBPHYEnableValue, .true, .@"=")) {
                USBPHYoutput.nodetype = .output;
                USBPHYoutput.parents = &.{&USBPHYMult};
            }
            ...
            if ((check_MCU("DSIHOST_Exist"))) {
                if (check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=")) {
                    ...
                    DSITXPrescaler.parents = &.{&DSIoutput};
                }
            }
            if ((check_MCU("DSIHOST_Exist"))) {
                if (check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=")) {
            ...
            if (check_ref(@TypeOf(USBPHYEnablePllValue), USBPHYEnablePllValue, .true, .@"=") or
            ...
            {
                const PLL1P_clk_value = PLL1PValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or
                check_ref(@TypeOf(SDMMCEnableLPBAMValue), SDMMCEnableLPBAMValue, .true, .@"=") or
            ...
            {
                const PLL1Q_clk_value = PLL1QValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(notInLPBAMValue), notInLPBAMValue, .true, .@"=")) {
                const PLL1R_clk_value = PLL1RValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or
                check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or
            ...
            {
                const PLL2N_clk_value = PLL2NValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            {
                const PLL2P_clk_value = PLL2PValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"=") or
                ...
                check_ref(@TypeOf(OCTOSPIMEnableLPBAMValue), OCTOSPIMEnableLPBAMValue, .true, .@"="))
            {
                const PLL2Q_clk_value = PLL2QValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or
                ...
                check_ref(@TypeOf(DACEnableLPBAMValue), DACEnableLPBAMValue, .true, .@"="))
            {
                const PLL2R_clk_value = PLL2RValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(EnableDSIValue), EnableDSIValue, .true, .@"=") or
                check_ref(@TypeOf(SAI1EnableLPBAMValue), SAI1EnableLPBAMValue, .true, .@"=") or
                check_ref(@TypeOf(SAI2EnableLPBAMValue), SAI2EnableLPBAMValue, .true, .@"=") or
                check_ref(@TypeOf(MDF1EnableLPBAMValue), MDF1EnableLPBAMValue, .true, .@"=") or
                check_ref(@TypeOf(ADF1EnableLPBAMValue), ADF1EnableLPBAMValue, .true, .@"=") or
                check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or
                check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))
            {
                const PLL3N_clk_value = PLL3NValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            {
                const PLL3P_clk_value = PLL3PValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(MDF1EnableLPBAMValue), MDF1EnableLPBAMValue, .true, .@"=") or
                check_ref(@TypeOf(ADF1EnableLPBAMValue), ADF1EnableLPBAMValue, .true, .@"="))
            {
                const PLL3Q_clk_value = PLL3QValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or
                check_ref(@TypeOf(HSPI1EnableValue), HSPI1EnableValue, .true, .@"="))
            {
                const PLL3R_clk_value = PLL3RValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            out.HSPIMult = try HSPIMult.get_output();
            out.HSPIoutput = try HSPIoutput.get_output();
            ...
            out.I2C6Mult = try I2C6Mult.get_output();
            out.I2C6output = try I2C6output.get_output();
            ...
            out.PLL1PDiv2 = try PLL1PDiv2.get_output();
            out.USBPHYMult = try USBPHYMult.get_output();
            out.USBPHYoutput = try USBPHYoutput.get_output();
            ...
            ref_out.HSPICLockSelection = HSPICLockSelectionValue;
            ...
            ref_out.I2C6CLockSelection = I2C6CLockSelectionValue;
            ...
            ref_out.HSEDiv2 = HSEDiv2Value;
            ref_out.PLL1PDiv2 = PLL1PDiv2Value;
            ref_out.USBPHYCLockSelection = USBPHYCLockSelectionValue;
            ...
            ref_out.RNGEnableLPBAM = RNGEnableLPBAMValue;
            ref_out.MCOEnable = MCOEnableValue;
            ref_out.SDMMCEnableLPBAM = SDMMCEnableLPBAMValue;
            ref_out.EnableSAES = EnableSAESValue;
            ...
            ref_out.HSPI1Enable = HSPI1EnableValue;
            ...
            ref_out.I2C6Enable = I2C6EnableValue;
            ...
            ref_out.MDF1Enable = MDF1EnableValue;
            ...
            ref_out.UCPD1Enable = UCPD1EnableValue;
            ref_out.SPI1Enable = SPI1EnableValue;
            ref_out.SPI3Enable = SPI3EnableValue;
            ref_out.SPI2Enable = SPI2EnableValue;
            ref_out.USBPHYEnableHSE = USBPHYEnableHSEValue;
            ref_out.USBPHYEnable = USBPHYEnableValue;
            ref_out.EnableDSI = EnableDSIValue;
            ref_out.USBPHYEnablePll = USBPHYEnablePllValue;
            ref_out.SAI1EnableLPBAM = SAI1EnableLPBAMValue;
            ref_out.SAI2EnableLPBAM = SAI2EnableLPBAMValue;
            ref_out.MDF1EnableLPBAM = MDF1EnableLPBAMValue;
            ref_out.ADF1EnableLPBAM = ADF1EnableLPBAMValue;
            ref_out.FDCANEnableLPBAM = FDCANEnableLPBAMValue;
            ref_out.OCTOSPIMEnableLPBAM = OCTOSPIMEnableLPBAMValue;
            ref_out.ADCEnableLPBAM = ADCEnableLPBAMValue;
            ref_out.DACEnableLPBAM = DACEnableLPBAMValue;
            ...
            ref_out.FullHSI48Used = FullHSI48UsedValue;
