...
pub const ClockTree = struct {
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const DCMIMult: ClockNode = .{
            ...
            .Nodetype = .{ .multi = @intFromEnum(config.DCMIMult) },
            .parents = &[_]*const ClockNode{
                &AXIOutput,
                &DIVQ2,
                &DIVP4,
        ...
        const ETH2Mult: ClockNode = .{
            ...
            .Nodetype = .{ .multi = @intFromEnum(config.ETH2Mult) },
            .parents = &[_]*const ClockNode{
                &DIVP4,
                &DIVQ3,
            },
        ...
        const ADC1Mult: ClockNode = .{
            ...
            .Nodetype = .{ .multi = @intFromEnum(config.ADC1Mult) },
            .parents = &[_]*const ClockNode{
                &DIVR4,
                &CKPERCLKOutput,
                &DIVQ3,
