...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const RCC_LPUART3SEL = enum(u2) {
            PCLK1 = 0,
            SYS = 1,
            HSI = 2,
            LSE = 3,
        ...
        pub const RCC_LPTIM3SEL = enum(u2) {
            PCLK1 = 0,
            LSI = 1,
            HSI = 2,
            LSE = 3,
        ...
        pub const LPTIM3CLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_LPTIM3SEL {
                return switch (self) {
            ...
            pub fn from_enum(item: RCC_LPTIM3SEL) anyerror!@This() {
                return switch (item) {
        ...
        pub const LPUART3CLockSelectionList = enum {
            RCC_LPUART3CLKSOURCE_PCLK1,
            RCC_LPUART3CLKSOURCE_SYSCLK,
            RCC_LPUART3CLKSOURCE_HSI,
            RCC_LPUART3CLKSOURCE_LSE,

            pub fn to_enum(self: @This()) anyerror!RCC_LPUART3SEL {
                return switch (self) {
                    .RCC_LPUART3CLKSOURCE_HSI => .HSI,
                    .RCC_LPUART3CLKSOURCE_PCLK1 => .PCLK1,
                    .RCC_LPUART3CLKSOURCE_LSE => .LSE,
                    .RCC_LPUART3CLKSOURCE_SYSCLK => .SYS,
                };
            }
            pub fn from_enum(item: RCC_LPUART3SEL) anyerror!@This() {
                return switch (item) {
                    .HSI => .RCC_LPUART3CLKSOURCE_HSI,
                    .PCLK1 => .RCC_LPUART3CLKSOURCE_PCLK1,
                    .LSE => .RCC_LPUART3CLKSOURCE_LSE,
                    .SYS => .RCC_LPUART3CLKSOURCE_SYSCLK,
                };
            }
        };
        ...
        pub const LPUART3EnableList = enum {
            true,
            false,
        };
        ...
        pub const OutputFlags = struct {
            ...
            LPUART3Enable: bool = false, //Reference flag
        ...
        pub const CubeMXConfig = struct {
            ...
            LPUART3CLockSelection: ?LPUART3CLockSelectionList = null,
        ...
        pub const CubeMXOutputConfig = struct {
            ...
            LPUART3CLockSelection: LPUART3CLockSelectionList,
        ...
        pub const Config = struct {
            ...
            LPTIM3CLockSelection: ?RCC_LPTIM3SEL = null,
            LPUART2CLockSelection: ?RCC_LPUART2SEL = null,
            LPUART3CLockSelection: ?RCC_LPUART3SEL = null,
            ...
            pub fn to_cubemx_config(self: Config) !CubeMXConfig {
                return CubeMXConfig{
                    ...
                    .LPUART3CLockSelection = if (self.LPUART3CLockSelection) |val| try LPUART3CLockSelectionList.from_enum(val) else null,
        ...
        pub const OutputConfig = struct {
            ...
            LPTIM3CLockSelection: RCC_LPTIM3SEL,
            LPUART2CLockSelection: RCC_LPUART2SEL,
            LPUART3CLockSelection: RCC_LPUART3SEL,
            ...
            pub fn from_cubemx_output_config(cubemx_config: CubeMXOutputConfig) !OutputConfig {
                return OutputConfig{
                    ...
                    .LPUART3CLockSelection = try cubemx_config.LPUART3CLockSelection.to_enum(),
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            var LPUART3SourcePCLK1: bool = false; //semaphore for processing, not an actual flag in the output;
            var LPUART3SourceSys: bool = false; //semaphore for processing, not an actual flag in the output;
            var LPUART3SourceHSI: bool = false; //semaphore for processing, not an actual flag in the output;
            var LPUART3SourceLSE: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var USBCLKSOURCE_MSI: bool = false; //semaphore for processing, not an actual flag in the output;
            var USBCLKSOURCE_HSI48: bool = false; //semaphore for processing, not an actual flag in the output;
            var USBCLKSOURCE_PLLQ: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var RNGCLKSOURCE_PLLQ: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var LPUART3Mult = ClockNode{
                .name = "LPUART3Mult",
                .nodetype = .off, //to be filled later with actual node types after processing
                .parents = &.{}, //to be filled later with actual parent references
            };

            var LPUART3output = ClockNode{
                .name = "LPUART3output",
                .nodetype = .off, //to be filled later with actual node types after processing
                .parents = &.{}, //to be filled later with actual parent references
            };
            ...
            const LPUART3CLockSelectionValue: LPUART3CLockSelectionList = blk: {
                const user_val = config.LPUART3CLockSelection;

                if (user_val) |val| {
                    switch (val) {
                        .RCC_LPUART3CLKSOURCE_PCLK1 => LPUART3SourcePCLK1 = true,
                        .RCC_LPUART3CLKSOURCE_SYSCLK => LPUART3SourceSys = true,
                        .RCC_LPUART3CLKSOURCE_HSI => LPUART3SourceHSI = true,
                        .RCC_LPUART3CLKSOURCE_LSE => LPUART3SourceLSE = true,
                    }
                }
                break :blk user_val orelse {
                    LPUART3SourcePCLK1 = true;
                    break :blk .RCC_LPUART3CLKSOURCE_PCLK1;
                };
            };
            ...
            const USBCLockSelectionValue: USBCLockSelectionList = blk: {
                ...
                if (user_val) |val| {
                    switch (val) {
                        .RCC_USBCLKSOURCE_MSI => USBCLKSOURCE_MSI = true,
                        .RCC_USBCLKSOURCE_HSI48 => USBCLKSOURCE_HSI48 = true,
                        .RCC_USBCLKSOURCE_PLLQ => USBCLKSOURCE_PLLQ = true,
                    }
                }
                break :blk user_val orelse {
                    USBCLKSOURCE_MSI = true;
            ...
            const RNGCLockSelectionValue: RNGCLockSelectionList = blk: {
                ...
                if (user_val) |val| {
                    switch (val) {
                        ...
                        .RCC_RNGCLKSOURCE_PLLQ => RNGCLKSOURCE_PLLQ = true,
                    }
                }
                break :blk user_val orelse {
                    RNGCLKSOURCE_MSI = true;
            ...
            const RTCEnableValue: RTCEnableList = blk: {
                if (config.flags.RTC_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LCDEnableValue: LCDEnableList = blk: {
                if (config.flags.LCD_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const EnableRTCWKUPValue: EnableRTCWKUPList = blk: {
                if (config.flags.RTC_Used and check_MCU("RTC_WAKEUP_INTERRUPT") and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const IWDGEnableValue: IWDGEnableList = blk: {
                if (config.flags.IWDG_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const USART1EnableValue: USART1EnableList = blk: {
                if (config.flags.USART1_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const USART2EnableValue: USART2EnableList = blk: {
                if (config.flags.USART2_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LPUART1EnableValue: LPUART1EnableList = blk: {
                if (config.flags.LPUART1_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LPTIM1EnableValue: LPTIM1EnableList = blk: {
                if (config.flags.LPTIM1_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LPTIM2EnableValue: LPTIM2EnableList = blk: {
                if (config.flags.LPTIM2_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LPTIM3EnableValue: LPTIM3EnableList = blk: {
                if (config.flags.LPTIM3_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const LPUART2EnableValue: LPUART2EnableList = blk: {
                if (config.flags.LPUART2_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };

            const LPUART3EnableValue: LPUART3EnableList = blk: {
                if (config.flags.LPUART3_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const ADCEnableValue: ADCEnableList = blk: {
                if (config.flags.ADC1_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const I2C1EnableValue: I2C1EnableList = blk: {
                if (config.flags.I2C1_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const I2C3EnableValue: I2C3EnableList = blk: {
                if (config.flags.I2C3_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const USBEnableValue: USBEnableList = blk: {
                if (config.flags.USB_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const RNGEnableValue: RNGEnableList = blk: {
                if (config.flags.RNG_Used and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const MCO2EnableValue: MCO2EnableList = blk: {
                if (config.flags.MCO2Config and true) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const HSI48UsedValue: u1 = blk: {
                if ((MCO1SOURCE_HSI48 and config.flags.MCOConfig) or (MCO2SOURCE_HSI48 and config.flags.MCO2Config) or (config.flags.USB_Used and USBCLKSOURCE_HSI48) or (config.flags.RNG_Used and RNGCLKSOURCE_HSI48)) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            if (check_ref(@TypeOf(LPTIM3EnableValue), LPTIM3EnableValue, .true, .@"=")) {
                ...
                LPTIM3Mult.parents = switch (LPTIM3CLockSelectionValue) {
                    .RCC_LPTIM3CLKSOURCE_PCLK1 => &.{&APBPrescaler},
            ...
            // ======= NODE LPUART3Mult ======
            if (check_ref(@TypeOf(LPUART3EnableValue), LPUART3EnableValue, .true, .@"=")) {
                LPUART3Mult.nodetype = .multi;
                LPUART3Mult.parents = switch (LPUART3CLockSelectionValue) {
                    .RCC_LPUART3CLKSOURCE_PCLK1 => &.{&APBPrescaler},
                    .RCC_LPUART3CLKSOURCE_SYSCLK => &.{&SysCLKOutput},
                    .RCC_LPUART3CLKSOURCE_HSI => &.{&HSIRC},
                    .RCC_LPUART3CLKSOURCE_LSE => &.{&LSEOSC},
                };
            }
            // ======= NODE LPUART3output ======
            if (check_ref(@TypeOf(LPUART3EnableValue), LPUART3EnableValue, .true, .@"=")) {
                LPUART3output.nodetype = .output;
                LPUART3output.parents = &.{&LPUART3Mult};
            }
            // ======= NODE TIM1output ======
            ...
            // ======= NODE PLLQ ======
            if (check_ref(@TypeOf(RNGEnableValue), RNGEnableValue, .true, .@"=") or check_ref(@TypeOf(TIM1EnableValue), TIM1EnableValue, .true, .@"=") or check_ref(@TypeOf(TIM15EnableValue), TIM15EnableValue, .true, .@"=") or check_ref(@TypeOf(USBEnableValue), USBEnableValue, .true, .@"=")) {
                PLLQ.nodetype = .div;
            ...
            //======= LPUART3Freq_Value ========
            const LPUART3Freq_ValueValue = LPUART3output.get_as_ref();
            ignore_value(LPUART3Freq_ValueValue);
            ...
            if (((TIM15SOURCEPll and true) or (TIM1SOURCEPll and true) or ((config.flags.USB_Used or config.flags.RNG_Used) and check_MCU("USBCLKSOURCE_PLL"))) and scale1) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 5.6e7,
                };
            } else if (((TIM15SOURCEPll and true) or (TIM1SOURCEPll and true) or ((config.flags.USB_Used or config.flags.RNG_Used) and check_MCU("USBCLKSOURCE_PLL"))) and scale2) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 1.9e7,
                };
            ...
            const PLLUsedValue: u1 = blk: {
                if ((config.flags.ADC1_Used and ADCSourcePllp) or (true and TIM15SOURCEPll) or (true and TIM1SOURCEPll) or (SysSourcePLL) or (MCOSourcePLL and config.flags.MCOConfig) or (MCO2SourcePLL and config.flags.MCO2Config) or (USBCLKSOURCE_PLLQ and (config.flags.RNG_Used or config.flags.USB_Used))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSIUsedValue: u1 = blk: {
                if (((config.flags.RNG_Used or config.flags.USB_Used) and USBCLKSOURCE_MSI) or (SysSourceMSI) or (config.flags.MCOConfig and MCO1SOURCE_MSI) or (config.flags.MCO2Config and MCO2SOURCE_MSI) or (PLLSourceMSI and (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=")))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSIAutoCalibrationValue: MSIAutoCalibrationList = blk: {
                if (config.flags.USB_Used and (USBCLKSOURCE_MSI or (USBCLKSOURCE_PLLQ and PLLSourceMSI)) and (config.flags.LSEOscillator or config.flags.LSEByPass)) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .ENABLED) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "USB_Used & (USBCLKSOURCE_MSI|(USBCLKSOURCE_PLLQ & PLLSourceMSI)) & (LSEOscillator | LSEByPass)",
                                "",
                                "ENABLED",
                                val,
                            });
            ...
            out.LPUART3Mult = try LPUART3Mult.get_output();
            out.LPUART3output = try LPUART3output.get_output();
            ...
            ignore_value(LPUART2Freq_ValueValue);
            ref_out.LPUART3CLockSelection = LPUART3CLockSelectionValue;
            ignore_value(LPUART3Freq_ValueValue);
            ...
            ref_out.flags.LPUART3Enable = LPUART3EnableValue == .true;
