...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Config_Output = struct {
            ...
            UART9Enable: ?UART9EnableList = null, //from extra RCC references
            UART8Enable: ?UART8EnableList = null, //from extra RCC references
            USART10Enable: ?USART10EnableList = null, //from extra RCC references
            USART11Enable: ?USART11EnableList = null, //from extra RCC references
            UART12Enable: ?UART12EnableList = null, //from extra RCC references
            ...
            ETHEnable: ?ETHEnableList = null, //from extra RCC references
            ...
            LPTIM4Enable: ?LPTIM4EnableList = null, //from extra RCC references
            LPTIM5Enable: ?LPTIM5EnableList = null, //from extra RCC references
            LPTIM6Enable: ?LPTIM6EnableList = null, //from extra RCC references
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var USART11Freq_ValueLimit: Limit = .{};
            var UART12Freq_ValueLimit: Limit = .{};
            ...
            var LPTIM6Freq_ValueLimit: Limit = .{};
            ...
            const PLLSourceValue: ?PLLSourceList = blk: {
                ...
                break :blk conf_item orelse .RCC_PLL1_SOURCE_CSI;
            };
            ...
            const PLL2SourceValue: ?PLL2SourceList = blk: {
                ...
                break :blk conf_item orelse .RCC_PLL2_SOURCE_CSI;
            };
            ...
            const PLL3SourceValue: ?PLL3SourceList = blk: {
                ...
                break :blk conf_item orelse .RCC_PLL3_SOURCE_CSI;
            };
            ...
            std.mem.doNotOptimizeAway(CSIdivTohdmiValue);
            ...
            std.mem.doNotOptimizeAway(UART7CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(UART9CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(UART8CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(USART10CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(USART11CLockSelectionValue);
            const USART11Freq_ValueValue: ?f32 = blk: {
                if (scale1) {
                    USART11Freq_ValueLimit = .{
                        .min = null,
                        .max = 2e8,
                    };
                    break :blk null;
            ...
            std.mem.doNotOptimizeAway(USART11Freq_ValueValue);
            ...
            std.mem.doNotOptimizeAway(UART12CLockSelectionValue);
            const UART12Freq_ValueValue: ?f32 = blk: {
                if (scale1) {
                    UART12Freq_ValueLimit = .{
                        .min = null,
                        .max = 2e8,
                    };
                    break :blk null;
            ...
            std.mem.doNotOptimizeAway(UART12Freq_ValueValue);
            ...
            const DACLowPowerCLockSelectionValue: ?DACLowPowerCLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_DACLPCLKSOURCE_LSE;
            };

            std.mem.doNotOptimizeAway(DACLowPowerCLockSelectionValue);
            ...
            const SDMMC1ClockSelectionValue: ?SDMMC1ClockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SDMMC1CLKSOURCE_PLL1Q;
            };
            ...
            const SDMMC2ClockSelectionValue: ?SDMMC2ClockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SDMMC2CLKSOURCE_PLL1Q;
            };
            ...
            const SAI1CLockSelectionValue: ?SAI1CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SAI1CLKSOURCE_PLL2P;
            };
            ...
            const SAI2CLockSelectionValue: ?SAI2CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SAI2CLKSOURCE_PLL2P;
            };
            ...
            std.mem.doNotOptimizeAway(I3C1CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM4CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM5CLockSelectionValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM6CLockSelectionValue);
            const LPTIM6Freq_ValueValue: ?f32 = blk: {
                if (scale1) {
                    LPTIM6Freq_ValueLimit = .{
                        .min = null,
                        .max = 2e8,
                    };
                    break :blk null;
            ...
            std.mem.doNotOptimizeAway(LPTIM6Freq_ValueValue);
            ...
            std.mem.doNotOptimizeAway(RCC_MCO2DivValue);
            ...
            const SPI3CLockSelectionValue: ?SPI3CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SPI3CLKSOURCE_PLL1Q;
            };
            ...
            const SPI2CLockSelectionValue: ?SPI2CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SPI2CLKSOURCE_PLL1Q;
            };
            ...
            std.mem.doNotOptimizeAway(Flash_DelayValue);
            ...
            std.mem.doNotOptimizeAway(UART7EnableValue);
            ...
            std.mem.doNotOptimizeAway(UART9EnableValue);
            ...
            std.mem.doNotOptimizeAway(UART8EnableValue);
            ...
            std.mem.doNotOptimizeAway(USART10EnableValue);
            ...
            std.mem.doNotOptimizeAway(USART11EnableValue);
            ...
            std.mem.doNotOptimizeAway(UART12EnableValue);
            ...
            std.mem.doNotOptimizeAway(ETHEnableValue);
            ...
            std.mem.doNotOptimizeAway(I3C1EnableValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM4EnableValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM5EnableValue);
            ...
            std.mem.doNotOptimizeAway(LPTIM6EnableValue);
            ...
            std.mem.doNotOptimizeAway(MCO2EnableValue);
            ...
            if (check_ref(@TypeOf(EnableExtClockForSAI1Value), EnableExtClockForSAI1Value, .true, .@"=")) {
                const AUDIOCLK_clk_value = EXTERNAL_CLOCK_VALUEValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("HDMI_CEC_Exist")) {
                if (check_ref(@TypeOf(CECEnableValue), CECEnableValue, .true, .@"=")) {
                    const CSIdivTohdmi_clk_value = CSIdivTohdmiValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(USART11EnableValue), USART11EnableValue, .true, .@"=")) {
                const USART11Mult_clk_value = USART11CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(USART11EnableValue), USART11EnableValue, .true, .@"=")) {
                USART11output.limit = USART11Freq_ValueLimit;
            ...
            if (check_MCU("UART12_Exist")) {
                if (check_ref(@TypeOf(UART12EnableValue), UART12EnableValue, .true, .@"=")) {
                    const UART12Mult_clk_value = UART12CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("UART12_Exist")) {
                if (check_ref(@TypeOf(UART12EnableValue), UART12EnableValue, .true, .@"=")) {
                    UART12output.limit = UART12Freq_ValueLimit;
            ...
            if (check_ref(@TypeOf(DACEnableValue), DACEnableValue, .true, .@"=")) {
                const DACMult_clk_value = DACLowPowerCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("USB_Exist")) {
                if (check_ref(@TypeOf(USBEnableValue), USBEnableValue, .true, .@"=")) {
                    const CK48Mult_clk_value = USBCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("ETH_Exist")) {
                if (check_ref(@TypeOf(ETHEnableValue), ETHEnableValue, .true, .@"=")) {
                    ETHoutput.limit = ETHFreq_ValueLimit;
            ...
            if (check_ref(@TypeOf(LPTIM6EnableValue), LPTIM6EnableValue, .true, .@"=")) {
                const LPTIM6Mult_clk_value = LPTIM6CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LPTIM6EnableValue), LPTIM6EnableValue, .true, .@"=")) {
                LPTIM6output.limit = LPTIM6Freq_ValueLimit;
            ...
            if (check_ref(@TypeOf(CKPEREnableValue), CKPEREnableValue, .true, .@"=")) {
                const CKPERMult_clk_value = CKPERSourceSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(UCPDEnableValue), UCPDEnableValue, .true, .@"=")) {
                const hsidivToUCPD_clk_value = hsidivToUCPDValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            ref_out.UART9Enable = UART9EnableValue;
            ref_out.UART8Enable = UART8EnableValue;
            ref_out.USART10Enable = USART10EnableValue;
            ref_out.USART11Enable = USART11EnableValue;
            ref_out.UART12Enable = UART12EnableValue;
            ...
            ref_out.ETHEnable = ETHEnableValue;
            ...
            ref_out.LPTIM4Enable = LPTIM4EnableValue;
            ref_out.LPTIM5Enable = LPTIM5EnableValue;
            ref_out.LPTIM6Enable = LPTIM6EnableValue;
