...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Config_Output = struct {
            ...
            QSPIEnable: ?QSPIEnableList = null, //from extra RCC references
            ...
            ADC12Enable: ?ADC12EnableList = null, //from extra RCC references
            ADC345Enable: ?ADC345EnableList = null, //from extra RCC references
            ...
            HRTIM1Enable: ?HRTIM1EnableList = null, //from extra RCC references
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var FLASH_LATENCY6: bool = false;
            var FLASH_LATENCY7: bool = false;
            var FLASH_LATENCY8: bool = false;
            ...
            var WatchDogFreq_ValueLimit: Limit = .{};
            var ADC12Freq_ValueLimit: Limit = .{};
            var ADC345Freq_ValueLimit: Limit = .{};
            var HRTIM1Freq_ValueLimit: Limit = .{};
            ...
            const HSE_VALUEValue: ?f32 = blk: {
                if (config.flags.HSEByPass) {
                    ...
                    break :blk config_val orelse 1000000;
            ...
            std.mem.doNotOptimizeAway(I2SCLockSelectionValue);
            ...
            const SAI1CLockSelectionValue: ?SAI1CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SAI1CLKSOURCE_SYSCLK;
            };
            ...
            const QSPICLockSelectionValue: ?QSPICLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_QSPICLKSOURCE_SYSCLK;
            };
            ...
            const ADC12CLockSelectionValue: ?ADC12CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_ADC12CLKSOURCE_SYSCLK;
            };
            ...
            const ADC345CLockSelectionValue: ?ADC345CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_ADC345CLKSOURCE_SYSCLK;
            };

            std.mem.doNotOptimizeAway(ADC345CLockSelectionValue);
            const ADC345Freq_ValueValue: ?f32 = blk: {
                ADC345Freq_ValueLimit = .{
                    .min = null,
                    .max = 1.7e8,
                };
                break :blk null;
            ...
            std.mem.doNotOptimizeAway(ADC345Freq_ValueValue);
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 30000000)|(HCLKFreq_Value= 30000000 )))", "No Extra Log", "FLASH_LATENCY_0", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale2 & ((HCLKFreq_Value < 12000000)|(HCLKFreq_Value= 12000000 )))", "No Extra Log", "FLASH_LATENCY_0", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1boost & ((HCLKFreq_Value < 34000000)|(HCLKFreq_Value= 34000000 )))", "No Extra Log", "FLASH_LATENCY_0", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 60000000)|(HCLKFreq_Value= 60000000 )))", "No Extra Log", "FLASH_LATENCY_1", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale2 & ((HCLKFreq_Value < 24000000)|(HCLKFreq_Value= 24000000 )))", "No Extra Log", "FLASH_LATENCY_1", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1boost & ((HCLKFreq_Value < 68000000)|(HCLKFreq_Value= 68000000 )))", "No Extra Log", "FLASH_LATENCY_1", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 90000000)|(HCLKFreq_Value= 90000000 )))", "No Extra Log", "FLASH_LATENCY_2", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1boost & ((HCLKFreq_Value < 102000000)|(HCLKFreq_Value= 102000000 )))", "No Extra Log", "FLASH_LATENCY_2", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 120000000)|(HCLKFreq_Value= 120000000 )))", "No Extra Log", "FLASH_LATENCY_3", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1boost & ((HCLKFreq_Value < 136000000)|(HCLKFreq_Value= 136000000 )))", "No Extra Log", "FLASH_LATENCY_3", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 150000000)|(HCLKFreq_Value= 150000000 )))", "No Extra Log", "FLASH_LATENCY_4", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1boost & ((HCLKFreq_Value < 170000000)|(HCLKFreq_Value= 170000000 )))", "No Extra Log", "FLASH_LATENCY_4", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(LSEFsyncValue);
            ...
            std.mem.doNotOptimizeAway(GPIOFsyncValue);
            ...
            std.mem.doNotOptimizeAway(USBFsyncValue);
            ...
            std.mem.doNotOptimizeAway(QSPIEnableValue);
            ...
            std.mem.doNotOptimizeAway(ADC12EnableValue);
            ...
            std.mem.doNotOptimizeAway(ADC345EnableValue);
            ...
            std.mem.doNotOptimizeAway(HRTIM1EnableValue);
            ...
            std.mem.doNotOptimizeAway(CodegenDisableForPeriphValue);
            ...
            if (check_ref(@TypeOf(IWDGEnableValue), IWDGEnableValue, .true, .@"=")) {
                IWDGOutput.limit = WatchDogFreq_ValueLimit;
            ...
            if (check_ref(@TypeOf(ADC345EnableValue), ADC345EnableValue, .true, .@"=")) {
                const ADC345Mult_clk_value = ADC345CLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(ADC345EnableValue), ADC345EnableValue, .true, .@"=")) {
                ADC345output.limit = ADC345Freq_ValueLimit;
            ...
            if (check_ref(@TypeOf(HRTIM1EnableValue), HRTIM1EnableValue, .true, .@"=")) {
                HRTIM1CLKoutput.limit = HRTIM1Freq_ValueLimit;
            ...
            ref_out.HRTIM1Enable = HRTIM1EnableValue;
