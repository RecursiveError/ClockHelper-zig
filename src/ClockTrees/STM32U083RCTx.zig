...
pub const Config = struct {
    ...
    LPTIM3Mult: LPTIM3CLockSelectionConf = .RCC_LPTIM3CLKSOURCE_PCLK1,
    LPUART2Mult: LPUART2CLockSelectionConf = .RCC_LPUART2CLKSOURCE_PCLK1,
    LPUART3Mult: LPUART3CLockSelectionConf = .RCC_LPUART3CLKSOURCE_PCLK1,
    ...
    USBMult: USBCLockSelectionConf = .RCC_USBCLKSOURCE_MSI,
    RNGMult: RNGCLockSelectionConf = .RCC_USBCLKSOURCE_MSI,
...
pub const ConfigWithRef = struct {
    ...
    LPTIM3CLockSelection: LPTIM3CLockSelectionConf = .RCC_LPTIM3CLKSOURCE_PCLK1,
    LPUART2CLockSelection: LPUART2CLockSelectionConf = .RCC_LPUART2CLKSOURCE_PCLK1,
    LPUART3CLockSelection: LPUART3CLockSelectionConf = .RCC_LPUART3CLKSOURCE_PCLK1,
    ...
    USBCLockSelection: USBCLockSelectionConf = .RCC_USBCLKSOURCE_MSI,
    RNGCLockSelection: RNGCLockSelectionConf = .RCC_USBCLKSOURCE_MSI,
...
pub const ClockTree = struct {
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const LPUART3Multval = ClockNodeTypes{ .multi = @intFromEnum(config.LPUART3Mult) };
