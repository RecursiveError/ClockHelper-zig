...
pub const ClockTree = struct {
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const PLLM1: ClockNode = .{
            .name = "PLLM1",
            .Nodetype = .{ .div = .{ .value = config.PLLM1.get(), .limit = .{ .max = 16, .min = 1 } } },
        ...
        const PLLM2: ClockNode = .{
            .name = "PLLM2",
            .Nodetype = .{ .div = .{ .value = config.PLLM2.get(), .limit = .{ .max = 16, .min = 1 } } },
            .parents = &[_]*const ClockNode{&PLLSource},
        };
        const PLLM3: ClockNode = .{
            .name = "PLLM3",
            .Nodetype = .{ .div = .{ .value = config.PLLM3.get(), .limit = .{ .max = 16, .min = 1 } } },
            .parents = &[_]*const ClockNode{&PLLSource},
        };
        ...
        const PLLSAI1N: ClockNode = .{
            .name = "PLLSAI1N",
            .Nodetype = .{ .mul = .{ .value = config.PLLSAI1N.get(), .limit = .{ .max = 127, .min = 8 } } },
        ...
        const ADCoutput: ClockNode = .{
            .name = "ADCoutput",
            .Nodetype = .{ .output = .{ .max = 120000000, .min = 1400000 } },
        ...
        const PLLSAI2N: ClockNode = .{
            .name = "PLLSAI2N",
            .Nodetype = .{ .mul = .{ .value = config.PLLSAI2N.get(), .limit = .{ .max = 127, .min = 8 } } },
        ...
        const PLLSAI2Q: ClockNode = .{
            .name = "PLLSAI2Q",
            .Nodetype = .{ .div = .{ .value = config.PLLSAI2Q.get() } },
            .parents = &[_]*const ClockNode{&PLLSAI2N},
        };
        ...
        const PLLSAI2RDIVIDER: ClockNode = .{
            ...
            .Nodetype = .{ .div = .{ .value = config.PLLSAI2RDIVIDER.get() } },
            .parents = &[_]*const ClockNode{&PLLSAI2R},
        };
