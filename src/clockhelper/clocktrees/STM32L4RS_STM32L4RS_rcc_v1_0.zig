...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const RCC_ADFSDMSEL = enum(u2) {
            PLLSAI1_P = 0,
            HSI = 1,
            MSI = 2,
        };
        ...
        pub const SDMMCClockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_SDMMCSEL {
                return switch (self) {
                    .RCC_SDIOCLKSOURCE_CLK48 => .HSI48,
                    .RCC_SDMMC1CLKSOURCE_PLLP => .PLL1_P,
                };
            }
            pub fn from_enum(item: RCC_SDMMCSEL) anyerror!@This() {
                return switch (item) {
                    .HSI48 => .RCC_SDIOCLKSOURCE_CLK48,
                    .PLL1_P => .RCC_SDMMC1CLKSOURCE_PLLP,
                };
            }
        };
        ...
        pub const DFSDMAudioCLockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_ADFSDMSEL {
                return switch (self) {
                    .RCC_DFSDM1AUDIOCLKSOURCE_SAI1 => .PLLSAI1_P,
                    .RCC_DFSDM1AUDIOCLKSOURCE_HSI => .HSI,
                    .RCC_DFSDM1AUDIOCLKSOURCE_MSI => .MSI,
                };
            }
            pub fn from_enum(item: RCC_ADFSDMSEL) anyerror!@This() {
                return switch (item) {
                    .PLLSAI1_P => .RCC_DFSDM1AUDIOCLKSOURCE_SAI1,
                    .HSI => .RCC_DFSDM1AUDIOCLKSOURCE_HSI,
                    .MSI => .RCC_DFSDM1AUDIOCLKSOURCE_MSI,
                };
            }
        };
            ...
            pub fn from_enum(item: RCC_PLLP) anyerror!@This() {
                return switch (item) {
                    ...
                    .Div4 => .RCC_PLLQ_DIV4,
                        ...
                        error.UnmappedListItem,
                        "{s} - {s} cannot be mapped to {s}List",
                        .{ "RCC_PLLP", @tagName(item), "PLLSAI2Q" },
                    ),
                };
            }
            pub fn get(self: @This()) !f32 {
        ...
        pub const LtdcClockSelectionList = enum {
            ...
            pub fn to_enum(self: @This()) anyerror!RCC_PLLP {
                return switch (self) {
                    .RCC_LTDCCLKSOURCE_PLLSAI2_DIV2 => .Div2,
                    .RCC_LTDCCLKSOURCE_PLLSAI2_DIV4 => .Div4,
                    .RCC_LTDCCLKSOURCE_PLLSAI2_DIV16 => .Div16,
                    .RCC_LTDCCLKSOURCE_PLLSAI2_DIV8 => .Div8,
                };
            }
            pub fn from_enum(item: RCC_PLLP) anyerror!@This() {
                return switch (item) {
                    .Div2 => .RCC_LTDCCLKSOURCE_PLLSAI2_DIV2,
                    .Div4 => .RCC_LTDCCLKSOURCE_PLLSAI2_DIV4,
                    .Div16 => .RCC_LTDCCLKSOURCE_PLLSAI2_DIV16,
                    .Div8 => .RCC_LTDCCLKSOURCE_PLLSAI2_DIV8,
                    else => return comptime_fail_or_error(
                        error.UnmappedListItem,
                        "{s} - {s} cannot be mapped to {s}List",
                        .{ "RCC_PLLP", @tagName(item), "LtdcClockSelection" },
                    ),
                };
            }
            pub fn get(self: @This()) !f32 {
        ...
        pub const Config = struct {
            ...
            DFSDMAudioCLockSelection: ?RCC_ADFSDMSEL = null,
            ...
            PLLSAI2Q: ?RCC_PLLP = null,
            PLLSAI2R: ?RCC_PLLP = null,
            LtdcClockSelection: ?RCC_PLLP = null,
            PLLDSIIDF: ?PLLDSIIDFList = null,
            PLLDSINDIV: ?u32 = null,
            PLLDSIODF: ?PLLDSIODFList = null,
            ...
            pub fn to_cubemx_config(self: Config) !CubeMXConfig {
                return CubeMXConfig{
                    ...
                    .DFSDMAudioCLockSelection = if (self.DFSDMAudioCLockSelection) |val| try DFSDMAudioCLockSelectionList.from_enum(val) else null,
                    ...
                    .PLLSAI2Q = if (self.PLLSAI2Q) |val| try PLLSAI2QList.from_enum(val) else null,
        ...
        pub const OutputConfig = struct {
            ...
            DFSDMAudioCLockSelection: RCC_ADFSDMSEL,
            ...
            pub fn from_cubemx_output_config(cubemx_config: CubeMXOutputConfig) !OutputConfig {
                return OutputConfig{
                    ...
                    .PLLM1 = cubemx_config.PLLM1,
                    .PLLM2 = cubemx_config.PLLM2,
                    .PLLM3 = cubemx_config.PLLM3,
                    ...
                    .DFSDMAudioCLockSelection = try cubemx_config.DFSDMAudioCLockSelection.to_enum(),
                    ...
                    .PLLSAI2Q = try cubemx_config.PLLSAI2Q.to_enum(),
        ...
        pub const ClockOutput = struct {
            ...
            PLLSAI2Q: u32 = 0,
            PLLSAI2Qoutput: u32 = 0,
            PLLSAI2R: u32 = 0,
            PLLSAI2Routput: u32 = 0,
            PLLSAI2RDIVIDER: u32 = 0,
            LTDCCLK: u32 = 0,
            PLLDSIIDF: u32 = 0,
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            var DSISourceisPLLSAI2: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            var FLASH_LATENCY3: bool = false; //semaphore for processing, not an actual flag in the output;
            var FLASH_LATENCY4: bool = false; //semaphore for processing, not an actual flag in the output;
            var FLASH_LATENCY5: bool = false; //semaphore for processing, not an actual flag in the output;
            ...
            const PLLM1Value: u32 = blk: {
                const user_val = config.PLLM1;
                if (user_val) |val| {
                    if (val < 1) {
                        return comptime_fail_or_error(error.InvalidConfig,
                            \\
            ...
            const PLLM2Value: u32 = blk: {
                const user_val = config.PLLM2;
                if (user_val) |val| {
                    if (val < 1) {
                        return comptime_fail_or_error(error.InvalidConfig,
                            \\
            ...
            const PLLM3Value: u32 = blk: {
                const user_val = config.PLLM3;
                if (user_val) |val| {
                    if (val < 1) {
                        return comptime_fail_or_error(error.InvalidConfig,
                            \\
            ...
            const PLLSAI2QValue: PLLSAI2QList = blk: {
                const user_val = config.PLLSAI2Q;
            ...
            const LtdcClockSelectionValue: LtdcClockSelectionList = blk: {
                ...
                break :blk user_val orelse .RCC_LTDCCLKSOURCE_PLLSAI2_DIV2;
            };
            ...
            const PLLUsedValue: u1 = blk: {
                if (((CK48SourcePLLCLK and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or (SDMMC1SourceIsPllP and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or (SAI1SourcePLLP and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1)) or (SAI2SourcePLLP and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)) or (SysSourcePLL) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_PLLCLK, .@"=")) and ((config.flags.Semaphore_input_Channel1TIM17 and config.flags.TIM17 and config.flags.SEM2RCC_MCO_REQUIRED_TIM17) or config.flags.MCOConfig)) or (CK48SourcePLLCLK and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC) or OCTOSPIMSourcePLL and (config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PLLSAI2UsedValue: u1 = blk: {
                if (config.flags.LTDCUsed_ForRCC or (DSISourceisPLLSAI2 and config.flags.DSIUsed_ForRCC) or ((SAI1SourcePLLSAI2P and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC)) or (DFSDMAudioSourceSAI and config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and SAI1SourcePLLSAI2P) or (SAI2SourcePLLSAI2P and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSIUsedValue: u1 = blk: {
                if ((CK48SourceMSI and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or (OCTOSPIMSourceMSI and (config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC)) or (DFSDMAudioSourceMSI and (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1)) or (config.flags.SEM2RCC_MSI_REQUIRED_TIM17 and config.flags.TIM17 and config.flags.Semaphore_input_Channel1TIM17) or (CK48SourceMSI and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC)) or (check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_MSI, .@"=")) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_MSI, .@"=")) and ((config.flags.Semaphore_input_Channel1TIM17 and config.flags.TIM17 and config.flags.SEM2RCC_MCO_REQUIRED_TIM17) or config.flags.MCOConfig)) or (PLLSourceMSI and (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAI1UsedValue), PLLSAI1UsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAI2UsedValue), PLLSAI2UsedValue, 1, .@"=")))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MSIAutoCalibrationValue: MSIAutoCalibrationList = blk: {
                if ((check_ref(@TypeOf(LSEStateValue), LSEStateValue, .RCC_LSE_OFF, .@"=")) and (CK48SourceMSI or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLCLK and PLLSourceMSI) or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLSAI1 and PLLSourceMSI))) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .ENABLED) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(LSEState=RCC_LSE_OFF) & (CK48SourceMSI|(USB_OTG_FSUsed_ForRCC&CK48SourcePLLCLK&PLLSourceMSI)|(USB_OTG_FSUsed_ForRCC&CK48SourcePLLSAI1&PLLSourceMSI))",
                                "",
                                "ENABLED",
                                val,
                            });
                    ...
                    break :blk .ENABLED;
                } else if (CK48SourceMSI or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLCLK and PLLSourceMSI) or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLSAI1 and PLLSourceMSI)) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .ENABLED) {
                            return comptime_fail_or_error(error.InvalidConfig,
                                \\
            ...
            const EnableHSEDSIValue: EnableHSEDSIList = blk: {
                if ((config.flags.DSIUsed_ForRCC) and (config.flags.HSEOscillator or config.flags.HSEByPass) or ((config.flags.HSEOscillator or config.flags.HSEByPass) and (config.flags.SEM2RCC_HSE_REQUIRED_TIM11 and config.flags.TIM11 and config.flags.Semaphore_input_Channel1TIM11))) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const HSI48UsedValue: u1 = blk: {
                if ((CK48SourceHSI48 and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or config.flags.CRSActivatedSourceGPIO or config.flags.CRSActivatedSourceLSE or config.flags.CRSActivatedSourceUSB or (CK48SourceHSI48 and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC)) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_HSI48, .@"=")) and ((((config.flags.Semaphore_input_Channel1TIM16 and config.flags.TIM16 and config.flags.SEM2RCC_MCO_REQUIRED_TIM16) or config.flags.MCOConfig))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            // ======= NODE PLLM1 ======
            PLLM1.nodetype = .div;
            PLLM1.value = @floatFromInt(PLLM1Value);
            PLLM1.parents = &.{&PLLSource};

            // ======= NODE PLLM2 ======
            PLLM2.nodetype = .div;
            PLLM2.value = @floatFromInt(PLLM2Value);
            PLLM2.parents = &.{&PLLSource};

            // ======= NODE PLLM3 ======
            PLLM3.nodetype = .div;
            PLLM3.value = @floatFromInt(PLLM3Value);
            ...
            if ((check_MCU("DSIHOST_Exist"))) {
                ...
                DSIMult.parents = switch (DSICLockSelectionValue) {
                    .RCC_DSICLKSOURCE_PLLSAI2 => &.{&PLLSAI2Q},
            ...
            PLLSAI2Q.value = try PLLSAI2QValue.get();
            ...
            // ======= NODE PLLSAI2RDIVIDER ======
            PLLSAI2RDIVIDER.nodetype = .div;
            PLLSAI2RDIVIDER.value = try LtdcClockSelectionValue.get();
            ...
            VCOInput.parents = &.{&PLLM1};

            // ======= NODE VCOInput2 ======
            VCOInput2.nodetype = .output;
            VCOInput2.parents = &.{&PLLM2};

            // ======= NODE VCOInput3 ======
            VCOInput3.nodetype = .output;
            VCOInput3.parents = &.{&PLLM3};
            ...
            if (config.flags.USB_OTG_FSUsed_ForRCC and ((config.flags.USE_ADC1 and (!config.flags.ADC1UsedAsynchronousCLK_ForRCC) or config.flags.USE_ADC2 and (!config.flags.ADC2UsedAsynchronousCLK_ForRCC)))) {
                AHBOutput.limit = .{
                    .min = 1.42e7,
                    .max = 1.2e8,
                    .main_expr = "USB_OTG_FSUsed_ForRCC & ((USE_ADC1 & (!ADC1UsedAsynchronousCLK_ForRCC)| USE_ADC2 & (!ADC2UsedAsynchronousCLK_ForRCC))) ",
                        ...
                        switch (val) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                                ...
                                , .{
                                    ...
                                    "(HCLKFreq_Value > 26000000) & ((HCLKFreq_Value < 80000000)|HCLKFreq_Value = 80000000)",
                                    "",
                                    @tagName(val),
                                    "PWR_REGULATOR_VOLTAGE_SCALE1_BOOST",
                                    "PWR_REGULATOR_VOLTAGE_SCALE1",
            ...
            if (config.flags.DSIUsed_ForRCC) {
                DSIoutput.limit = .{
                    .min = null,
                    .max = 6.25e7,
                    .main_expr = "DSIUsed_ForRCC",
                    .main_dialog = "PLLSAI2 used",
                };
            } else {
                DSIoutput.limit = .{
                    .min = null,
            ...
            if (((SAI1SourcePLLP and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1)) or (SAI2SourcePLLP and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)) or (SDMMC1SourceIsPllP and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)))) {
                PLLPoutput.limit = .{
                    .min = 2.064e6,
                    .max = 1.2e8,
                    .main_expr = "((SAI1SourcePLLP &(SAI1_SAIBUsed_ForRCC|SAI1_SAIAUsed_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))| (SAI2SourcePLLP & (SAI2_SAIBUsed_ForRCC|SAI2_SAIAUsed_ForRCC)) |(SDMMC1SourceIsPllP & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)))",
                    .main_dialog = " ",
                };
            }
            ...
            if (((config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC) and CK48SourcePLLCLK) or ((config.flags.OCTOSPI1Used_ForRCC or config.flags.OCTOSPI2Used_ForRCC) and OCTOSPIMSourcePLL) or (CK48SourcePLLCLK and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) {
                PLLQoutput.limit = .{
                    .min = 8e6,
                    .max = 1.2e8,
                    .main_expr = "((USB_OTG_FSUsed_ForRCC|USB_OTG_HSEmbeddedPHYUsed_ForRCC|RNGUsed_ForRCC)& CK48SourcePLLCLK) | ((OCTOSPI1Used_ForRCC|OCTOSPI2Used_ForRCC) & OCTOSPIMSourcePLL) | (CK48SourcePLLCLK & SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))",
                    .main_dialog = " ",
                };
            }
            ...
            if (((SAI1SourcePLLSAI1P and (config.flags.SAI1_SAIBUsed_ForRCC or config.flags.SAI1_SAIAUsed_ForRCC or config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1)) or (SAI2SourcePLLSAI1P and (config.flags.SAI2_SAIBUsed_ForRCC or config.flags.SAI2_SAIAUsed_ForRCC)))) {
                PLLSAI1Poutput.limit = .{
                    .min = 2.064e6,
                    .max = 1.2e8,
                    .main_expr = "((SAI1SourcePLLSAI1P&(SAI1_SAIBUsed_ForRCC|SAI1_SAIAUsed_ForRCC|SEM2RCC_SAI1_CK_REQUIRED_DFSDM1))| (SAI2SourcePLLSAI1P&(SAI2_SAIBUsed_ForRCC|SAI2_SAIAUsed_ForRCC)))",
                    .main_dialog = " ",
                };
            }
            ...
            if (((config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC) and CK48SourcePLLSAI1) or (CK48SourcePLLSAI1 and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) {
                PLLSAI1Qoutput.limit = .{
                    .min = 8e6,
                    .max = 1.2e8,
                    .main_expr = "((USB_OTG_FSUsed_ForRCC|USB_OTG_HSEmbeddedPHYUsed_ForRCC|RNGUsed_ForRCC)& CK48SourcePLLSAI1) | (CK48SourcePLLSAI1 & SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))",
                    .main_dialog = " ",
                };
            }
            ...
            if ((ADCSourcePLLSAI1R and (config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC or config.flags.USE_ADC2 and config.flags.ADC2UsedAsynchronousCLK_ForRCC))) {
                PLLSAI1Routput.limit = .{
                    .min = 8e6,
                    .max = 1.2e8,
                    .main_expr = "(ADCSourcePLLSAI1R & (USE_ADC1 &ADC1UsedAsynchronousCLK_ForRCC| USE_ADC2 &ADC2UsedAsynchronousCLK_ForRCC))",
                    .main_dialog = " ",
                };
            }
            ...
            //======= PLLSAI2QoutputFreq_Value ========
            const PLLSAI2QoutputFreq_ValueValue = PLLSAI2Qoutput.get_as_ref();
            ignore_value(PLLSAI2QoutputFreq_ValueValue);
            if (DSISourceisPLLSAI2 and config.flags.DSIUsed_ForRCC) {
                PLLSAI2Qoutput.limit = .{
                    .min = 8e6,
                    .max = 1.2e8,
                    .main_expr = "DSISourceisPLLSAI2 & DSIUsed_ForRCC",
                    .main_dialog = " ",
                };
            }
            ...
            //======= LCDTFTFreq_Value ========
            const LCDTFTFreq_ValueValue = LTDCCLK.get_as_ref();
                ...
                if (((scale1 or scale1boost) and ((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 20000000, .@"<")) or (check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 20000000, .@"=")))) or (scale2 and ((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 8000000, .@"<")) or (check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 8000000, .@"="))))) {
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_0) {
                            ...
                            , .{
                                "FLatency",
                                "((scale1 | scale1boost) & ((HCLKFreq_Value < 20000000)|(HCLKFreq_Value= 20000000 )))|(scale2 & ((HCLKFreq_Value < 8000000)|(HCLKFreq_Value= 8000000 )))",
                                "",
                                "FLASH_LATENCY_0",
                                val,
                            });
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_1) {
                            ...
                            , .{
                                "FLatency",
                                "((scale1 | scale1boost) & ((HCLKFreq_Value < 40000000)|(HCLKFreq_Value= 40000000 )))|(scale2 & ((HCLKFreq_Value < 16000000)|(HCLKFreq_Value= 16000000 )))",
                                "",
                                "FLASH_LATENCY_1",
                                val,
                            });
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_2) {
                            ...
                            , .{
                                "FLatency",
                                "((scale1 | scale1boost) & ((HCLKFreq_Value < 60000000)|(HCLKFreq_Value= 60000000 )))|(scale2 & ((HCLKFreq_Value < 26000000)|(HCLKFreq_Value= 26000000 )))",
                                "",
                                "FLASH_LATENCY_2",
                                val,
                            });
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_3) {
                            ...
                            , .{
                                "FLatency",
                                "((scale1 | scale1boost) & ((HCLKFreq_Value < 80000000)|(HCLKFreq_Value= 80000000 )))",
                                "",
                                "FLASH_LATENCY_3",
                                val,
                            });
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_4) {
                            ...
                            , .{
                                "FLatency",
                                "(scale1boost & ((HCLKFreq_Value < 100000000)|(HCLKFreq_Value= 100000000 )))",
                                "",
                                "FLASH_LATENCY_4",
                                val,
                            });
                    ...
                    if (config.extra_config.FLatency) |val| {
                        if (val != .FLASH_LATENCY_5) {
                            ...
                            , .{
                                "FLatency",
                                "(scale1boost & ((HCLKFreq_Value < 120000000)|(HCLKFreq_Value= 120000000 )))",
                                "",
                                "FLASH_LATENCY_5",
                                val,
                            });
            ...
            if (!(check_ref(@TypeOf(USBEnableValue), USBEnableValue, .true, .@"=") or check_ref(@TypeOf(RNGEnableValue), RNGEnableValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableValue), OCTOSPIMEnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableValue), SDMMCEnableValue, .true, .@"="))) {
                PLLQ.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(USBEnableValue), USBEnableValue, .true, .@"=") or check_ref(@TypeOf(RNGEnableValue), RNGEnableValue, .true, .@"=") or check_ref(@TypeOf(OCTOSPIMEnableValue), OCTOSPIMEnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableValue), SDMMCEnableValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=") or check_ref(@TypeOf(EnableHSEDSIValue), EnableHSEDSIValue, .true, .@"=") or check_ref(@TypeOf(SAI1EnableValue), SAI1EnableValue, .true, .@"=") or check_ref(@TypeOf(SAI2EnableValue), SAI2EnableValue, .true, .@"="))) {
            ...
            if (!(check_ref(@TypeOf(EnableHSEDSIValue), EnableHSEDSIValue, .true, .@"="))) {
                PLLSAI2Q.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableHSEDSIValue), EnableHSEDSIValue, .true, .@"="))) {
                PLLSAI2Qoutput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
                PLLSAI2R.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
                PLLSAI2Routput.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
                PLLSAI2RDIVIDER.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"="))) {
                LTDCCLK.nodetype = .off;
            }
            if (!(check_ref(@TypeOf(EnableHSEDSIValue), EnableHSEDSIValue, .true, .@"="))) {
