...
pub const ClockTree = struct {
    ...
    pub fn init_runtime_tree(self: *Self, alloc: std.mem.Allocator) !void {
        ...
        self.I2S2ClkOutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.SysCLKOutput,
        });
        self.I2S3ClkOutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.SysCLKOutput,
        });
        ...
        self.HCLKDiv2.parents = try alloc.dupe(*const ClockNode, &.{
            &self.AHBOutput,
        });
        self.SDIOHCLKDiv2.parents = try alloc.dupe(*const ClockNode, &.{
            &self.HCLKDiv2,
        });
        self.HCLKOutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.AHBOutput,
        });
        self.FSMClkOutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.AHBOutput,
        });
        self.SDIOClkOutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.AHBOutput,
        });
    ...
    pub fn deinit_runtime_tree(self: *Self, alloc: std.mem.Allocator) void {
        ...
        alloc.free(self.I2S2ClkOutput.parents.?);
        alloc.free(self.I2S3ClkOutput.parents.?);
        ...
        alloc.free(self.HCLKDiv2.parents.?);
        alloc.free(self.SDIOHCLKDiv2.parents.?);
        alloc.free(self.HCLKOutput.parents.?);
        alloc.free(self.FSMClkOutput.parents.?);
        alloc.free(self.SDIOClkOutput.parents.?);
    ...
    pub fn runtime_apply(self: *Self, config: Config) error{InvalidConfig}!void {
        ...
        const I2S2ClkOutputval = ClockNodeTypes{ .output = null };
        self.I2S2ClkOutput.nodetype = I2S2ClkOutputval;
        const I2S3ClkOutputval = ClockNodeTypes{ .output = null };
        self.I2S3ClkOutput.nodetype = I2S3ClkOutputval;
        const HSERTCDevisorval = ClockNodeTypes{
            .div = .{ .value = 128 },
        };
        ...
        self.HCLKDiv2.nodetype = HCLKDiv2val;
        const SDIOHCLKDiv2val = ClockNodeTypes{ .output = null };
        self.SDIOHCLKDiv2.nodetype = SDIOHCLKDiv2val;
        const HCLKOutputval = ClockNodeTypes{ .output = null };
        self.HCLKOutput.nodetype = HCLKOutputval;
        const FSMClkOutputval = ClockNodeTypes{ .output = null };
        self.FSMClkOutput.nodetype = FSMClkOutputval;
        const SDIOClkOutputval = ClockNodeTypes{ .output = null };
        self.SDIOClkOutput.nodetype = SDIOClkOutputval;
        const FCLKCortexOutputval = ClockNodeTypes{ .output = null };
