...
pub const MSIAutoCalibrationConf = enum(u32) {
    _,
    pub fn get(num: @This()) f32 {
        const val: u32 = @intFromEnum(num);
        return @as(f32, @floatFromInt(val));
...
pub const Config = struct {
    ...
    MSIAutoCalibration: MSIAutoCalibrationConf = @enumFromInt(12297829382473034410),
...
pub const ClockTree = struct {
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const ADCoutputval = ClockNodeTypes{
            .output = .{ .max = 80000000, .min = 1400000 },
        };
        ...
        const MSIAutoCalibrationval = ClockNodeTypes{
            .source = .{
                .value = config.MSIAutoCalibration.get(),
