...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Flags = struct {
            ...
            SEM2RCC_MCO1_REQUIRED_TIM11: bool = false,
            TIM11: bool = false,
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            const PLLUsedValue: u1 = blk: {
                if ((config.flags.DSIUsed_ForRCC and DSISourceisPLLR) or (SysSourceIsPLLclk) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_PLLCLK, .@"=")) and (config.flags.MCO1Config or (config.flags.Semaphore_input_Channel1TIM11 and config.flags.TIM11 and config.flags.SEM2RCC_MCO1_REQUIRED_TIM11))) or ((check_ref(@TypeOf(RCC_MCO2SourceValue), RCC_MCO2SourceValue, .RCC_MCO2SOURCE_PLLCLK, .@"=")) and config.flags.MCO2Config) or (USBSourceisPLL and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48) or (config.flags.SDMMC1Used_ForRCC and SDMMC1SourceCK48)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PLLSAIUsedValue: u1 = blk: {
                if (config.flags.LTDCUsed_ForRCC or ((SAI1SourcePLLSAI and ((config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1)))) or (SAI2SourcePLLSAI and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2)))) or (((config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.USB_OTG_FSUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48) or (SDMMC1SourceCK48 and config.flags.SDMMC1Used_ForRCC)) and USBSourceisPLLSAI))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PLLI2SUsedValue: u1 = blk: {
                if ((config.flags.MCO2Config and MCOSourceIsPLLI2SP) or ((SAI1SourcePLLI2S and ((config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1)))) or (SAI2SourcePLLI2S and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2)))) or (I2SSourceIsPLLI2SR and (config.flags.I2S1Used_ForRCC or config.flags.I2S2Used_ForRCC or config.flags.I2S3Used_ForRCC)) or config.flags.SPDIFRXUsed_ForRCC) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const HSIUsedValue: u1 = blk: {
                if ((USART1SourceHSI and config.flags.USART1Used_ForRCC) or (USART2SourceHSI and config.flags.USART2Used_ForRCC) or (USART3SourceHSI and config.flags.USART3Used_ForRCC) or (USART6SourceHSI and config.flags.USART6Used_ForRCC) or (UART4SourceHSI and config.flags.UART4Used_ForRCC) or (UART5SourceHSI and config.flags.UART5Used_ForRCC) or (UART7SourceHSI and config.flags.UART7Used_ForRCC) or (UART8SourceHSI and config.flags.UART8Used_ForRCC) or (LPTIM1SOURCEHSI and config.flags.LPTIMUsed_ForRCC) or (I2C1SourceHSI and config.flags.I2C1Used_ForRCC) or (I2C2SourceHSI and config.flags.I2C2Used_ForRCC) or (I2C3SourceHSI and config.flags.I2C3Used_ForRCC) or (I2C4SourceHSI and config.flags.I2C4Used_ForRCC) or (CECSourceHSI and config.flags.CECUsed_ForRCC) or ((PLLSourceHSI) and (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAIUsedValue), PLLSAIUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLI2SUsedValue), PLLI2SUsedValue, 1, .@"=") or (SAI1SourcePLLsrc and (config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1))) or (SAI2SourcePLLsrc and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2))))) or (check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_HSI, .@"=")) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_HSI, .@"=")) and (((config.flags.MCO1Config or (config.flags.Semaphore_input_Channel1TIM11 and config.flags.TIM11 and config.flags.SEM2RCC_MCO1_REQUIRED_TIM11)))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const LSEUsedValue: u1 = blk: {
                if ((config.flags.SEM2RCC_LSE_REQUIRED_TIM5 and config.flags.TIM5 and config.flags.Semaphore_input_Channel4TIM5) or (CECSourceLSE and config.flags.CECUsed_ForRCC) or (USART1SourceLSE and config.flags.USART1Used_ForRCC) or (USART2SourceLSE and config.flags.USART2Used_ForRCC) or (USART3SourceLSE and config.flags.USART3Used_ForRCC) or (USART6SourceLSE and config.flags.USART6Used_ForRCC) or (UART4SourceLSE and config.flags.UART4Used_ForRCC) or (UART5SourceLSE and config.flags.UART5Used_ForRCC) or (UART7SourceLSE and config.flags.UART7Used_ForRCC) or (UART8SourceLSE and config.flags.UART8Used_ForRCC) or (LPTIM1SOURCELSE and config.flags.LPTIMUsed_ForRCC) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_LSE, .@"=")) and (config.flags.MCO1Config or (config.flags.Semaphore_input_Channel1TIM11 and config.flags.TIM11 and config.flags.SEM2RCC_MCO1_REQUIRED_TIM11))) or ((check_ref(@TypeOf(RTCClockSelectionValue), RTCClockSelectionValue, .RCC_RTCCLKSOURCE_LSE, .@"=")) and (config.flags.RTCUsed_ForRCC))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const MCO1OutPutEnableValue: MCO1OutPutEnableList = blk: {
                if (config.flags.MCO1Config or (config.flags.Semaphore_input_Channel1TIM11 and config.flags.TIM11 and config.flags.SEM2RCC_MCO1_REQUIRED_TIM11)) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const HSEUsedValue: u1 = blk: {
                if (config.flags.DSIUsed_ForRCC or ((config.flags.HSEByPass or config.flags.HSEOscillator) and (config.flags.SEM2RCC_HSE_REQUIRED_TIM11 and config.flags.TIM11 and config.flags.Semaphore_input_Channel1TIM11)) or ((config.flags.RTCUsed_ForRCC) and !((check_ref(@TypeOf(RTCClockSelectionValue), RTCClockSelectionValue, .RCC_RTCCLKSOURCE_LSE, .@"=")) or (check_ref(@TypeOf(RTCClockSelectionValue), RTCClockSelectionValue, .RCC_RTCCLKSOURCE_LSI, .@"=")))) or ((PLLSourceHSE) and (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAIUsedValue), PLLSAIUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLI2SUsedValue), PLLI2SUsedValue, 1, .@"=") or (SAI1SourcePLLsrc and (config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1))) or (SAI2SourcePLLsrc and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2))))) or (check_ref(@TypeOf(SYSCLKSourceValue), SYSCLKSourceValue, .RCC_SYSCLKSOURCE_HSE, .@"=")) or ((check_ref(@TypeOf(RCC_MCO1SourceValue), RCC_MCO1SourceValue, .RCC_MCO1SOURCE_HSE, .@"=")) and ((config.flags.MCO1Config or (config.flags.Semaphore_input_Channel1TIM11 and config.flags.TIM11 and config.flags.SEM2RCC_MCO1_REQUIRED_TIM11)))) or (((check_ref(@TypeOf(RCC_MCO2SourceValue), RCC_MCO2SourceValue, .RCC_MCO2SOURCE_HSE, .@"=")) or (MCOSourceIsPLLI2SP and (check_ref(@TypeOf(PLLSourceVirtualValue), PLLSourceVirtualValue, .RCC_PLLSOURCE_HSE, .@"=")))) and (config.flags.MCO2Config))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const LSIUsedValue: u1 = blk: {
                if ((config.flags.SEM2RCC_LSI_REQUIRED_TIM5 and config.flags.TIM5 and config.flags.Semaphore_input_Channel4TIM5) or (LPTIM1SOURCELSI and config.flags.LPTIMUsed_ForRCC) or (config.flags.IWDGUsed_ForRCC or ((check_ref(@TypeOf(RTCClockSelectionValue), RTCClockSelectionValue, .RCC_RTCCLKSOURCE_LSI, .@"=")) and (config.flags.RTCUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            if ((USBSourceisPLL and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48) or (config.flags.SDMMC1Used_ForRCC and SDMMC1SourceCK48)))) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 7.5e7,
                    .main_expr = "(USBSourceisPLL & (USB_OTG_FSUsed_ForRCC|USB_OTG_HSEmbeddedPHYUsed_ForRCC|RNGUsed_ForRCC|(SDMMC2Used_ForRCC&SDMMC2SourceCK48)|(SDMMC1Used_ForRCC&SDMMC1SourceCK48)))",
            ...
            if ((((config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.USB_OTG_FSUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48) or (SDMMC1SourceCK48 and config.flags.SDMMC1Used_ForRCC)) and USBSourceisPLLSAI))) {
                PLLSAIoutput.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "(((USB_OTG_HSEmbeddedPHYUsed_ForRCC|USB_OTG_FSUsed_ForRCC|RNGUsed_ForRCC|(SDMMC2Used_ForRCC&SDMMC2SourceCK48)|(SDMMC1SourceCK48 &SDMMC1Used_ForRCC))&USBSourceisPLLSAI))",
            ...
            if ((config.flags.MCO2Config and MCOSourceIsPLLI2SP) or (I2SSourceIsPLLI2SR and (config.flags.I2S1Used_ForRCC or config.flags.I2S2Used_ForRCC or config.flags.I2S3Used_ForRCC))) {
                PLLI2SRoutput.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "(MCO2Config & MCOSourceIsPLLI2SP)|(I2SSourceIsPLLI2SR &(I2S1Used_ForRCC|I2S2Used_ForRCC|I2S3Used_ForRCC))",
                    .main_dialog = "PLL not used",
                };
            }
            ...
            if (check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLSAIUsedValue), PLLSAIUsedValue, 1, .@"=") or check_ref(@TypeOf(PLLI2SUsedValue), PLLI2SUsedValue, 1, .@"=")) {
                VCOInput.limit = .{
                    .min = 9.5e5,
                    .max = 2.1e6,
                    .main_expr = "PLLUsed=1|PLLSAIUsed=1|PLLI2SUsed=1",
                    .main_dialog = "PLLM used",
                };
            }
            ...
            if (((SAI1SourcePLLSAI and ((config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1)))) or (SAI2SourcePLLSAI and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2))))) {
                PLLSAIQCLK.limit = .{
                    .min = null,
                    .max = 7.5e7,
                    .main_expr = "((SAI1SourcePLLSAI &((SAI1Used_ForRCC|(DFSDM1Used_ForRCC & SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 & DFSDMADSourceSAI1))))| (SAI2SourcePLLSAI&(SAI2Used_ForRCC|(DFSDM1Used_ForRCC & SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 & DFSDMADSourceSAI2))))",
                    .main_dialog = "PLL not used",
                };
            }
            ...
            if (config.flags.SPDIFRXUsed_ForRCC) {
                PLLI2SPCLK.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "SPDIFRXUsed_ForRCC",
                    .main_dialog = "PLLI2SP not used",
                };
            }
            ...
            if (((SAI1SourcePLLI2S and ((config.flags.SAI1Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI1)))) or (SAI2SourcePLLI2S and (config.flags.SAI2Used_ForRCC or (config.flags.DFSDM1Used_ForRCC and config.flags.SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 and DFSDMADSourceSAI2))))) {
                PLLI2SQCLK.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "((SAI1SourcePLLI2S &((SAI1Used_ForRCC|(DFSDM1Used_ForRCC & SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 & DFSDMADSourceSAI1))))| (SAI2SourcePLLI2S&(SAI2Used_ForRCC|(DFSDM1Used_ForRCC & SEM2RCC_SAI1_CK_REQUIRED_DFSDM1 & DFSDMADSourceSAI2))))",
                    .main_dialog = "PLL not used",
                };
            }
