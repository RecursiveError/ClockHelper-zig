...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            std.mem.doNotOptimizeAway(EXTERNALSAI2_CLOCK_VALUEValue);
            ...
            const HCLKFreq_ValueValue: ?f32 = blk: {
                if (config.flags.USB_OTG_FSUsed_ForRCC and (config.flags.USE_ADC1 or config.flags.USE_ADC2 or config.flags.USE_ADC3) and (!config.flags.ADC1UsedAsynchronousCLK_ForRCC or !config.flags.ADC2UsedAsynchronousCLK_ForRCC or !config.flags.ADC3UsedAsynchronousCLK_ForRCC)) {
                    ...
                    break :blk null;
                } else if (!config.flags.USB_OTG_FSUsed_ForRCC and (config.flags.USE_ADC1 or config.flags.USE_ADC2 or config.flags.USE_ADC3) and (!config.flags.ADC1UsedAsynchronousCLK_ForRCC or !config.flags.ADC2UsedAsynchronousCLK_ForRCC or !config.flags.ADC3UsedAsynchronousCLK_ForRCC)) {
                    break :blk 4000000;
            ...
            std.mem.doNotOptimizeAway(PLLSAI2NValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAI2PValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAI2RValue);
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 16000000)|(HCLKFreq_Value= 16000000 )))|(scale2 & ((HCLKFreq_Value < 6000000)|(HCLKFreq_Value= 6000000 )))", "No Extra Log", "FLASH_LATENCY_0", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 32000000)|(HCLKFreq_Value= 32000000 )))|(scale2 & ((HCLKFreq_Value < 12000000)|(HCLKFreq_Value= 12000000 )))", "No Extra Log", "FLASH_LATENCY_1", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 48000000)|(HCLKFreq_Value= 48000000 )))|(scale2 & ((HCLKFreq_Value < 18000000)|(HCLKFreq_Value= 18000000 )))", "No Extra Log", "FLASH_LATENCY_2", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 64000000)|(HCLKFreq_Value= 64000000 )))|(scale2 & ((HCLKFreq_Value < 26000000)|(HCLKFreq_Value= 26000000 )))", "No Extra Log", "FLASH_LATENCY_3", i });
                        }
                    }
                    break :blk item;
                    ...
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "FLatency", "(scale1 & ((HCLKFreq_Value < 80000000)|(HCLKFreq_Value= 80000000 )))|(scale2 & ((HCLKFreq_Value < 26000000)|(HCLKFreq_Value= 26000000 )))", "No Extra Log", "FLASH_LATENCY_4", i });
                        }
                    }
                    break :blk item;
                }
            ...
            std.mem.doNotOptimizeAway(PLLSAI2UsedValue);
            ...
            const MSIAutoCalibrationValue: ?MSIAutoCalibrationList = blk: {
                if (CK48SourceMSI or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLCLK and check_MCU("PLLSourceMSI")) or (config.flags.USB_OTG_FSUsed_ForRCC and CK48SourcePLLSAI1 and check_MCU("PLLSourceMSI"))) {
            ...
            std.mem.doNotOptimizeAway(EnableExtClockForSAI2Value);
