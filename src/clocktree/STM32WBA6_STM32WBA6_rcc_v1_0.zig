...
pub const I2C2CLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            ...
            .RCC_I2C2CLKSOURCE_PCLK1 => 1,
            .RCC_I2C2CLKSOURCE_SYSCLK => 2,
        };
    }
};
pub const I2C4CLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_I2C4CLKSOURCE_HSI => 0,
            .RCC_I2C4CLKSOURCE_PCLK1 => 1,
            .RCC_I2C4CLKSOURCE_SYSCLK => 2,
        };
    }
};
...
pub const OTGPHYPLLCLKYCLockSelectionList = enum {
    RCC_USBOTGHSPHYCLKSOURCE_HSE,
    RCC_USBOTGHSPHYCLKSOURCE_HSE_DIV2,
    RCC_USBOTGHSPHYCLKSOURCE_PLL1P,
    RCC_USBOTGHSPHYCLKSOURCE_PLL1P_DIV2,
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_USBOTGHSPHYCLKSOURCE_HSE => 0,
            .RCC_USBOTGHSPHYCLKSOURCE_HSE_DIV2 => 1,
            .RCC_USBOTGHSPHYCLKSOURCE_PLL1P => 2,
            .RCC_USBOTGHSPHYCLKSOURCE_PLL1P_DIV2 => 3,
        };
    }
};
...
pub const CortexCLockSelectionList = enum {
    RCC_SYSTICKCLKSOURCE_HSI_DIV4,
    RCC_SYSTICKCLKSOURCE_HCLK_DIV8,
    RCC_SYSTICKCLKSOURCE_LSE,
    RCC_SYSTICKCLKSOURCE_LSI,
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_SYSTICKCLKSOURCE_HSI_DIV4 => 0,
            .RCC_SYSTICKCLKSOURCE_HCLK_DIV8 => 1,
            .RCC_SYSTICKCLKSOURCE_LSE => 2,
            .RCC_SYSTICKCLKSOURCE_LSI => 3,
        };
    }
};
...
pub const OTGPHYPLLCLKFreq_ValueList = enum {
    @"16000000",
    @"32000000",
    pub fn get(self: @This()) f32 {
        return switch (self) {
...
pub const OTGHSPHYEnableList = enum {
    true,
    false,
};
...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Config = struct {
            ...
            OTGPHYPLLCLKYCLockSelection: ?OTGPHYPLLCLKYCLockSelectionList = null,
        ...
        pub const Clock_Output = struct {
            ...
            RNGMult: f32 = 0,
            RNGoutput: f32 = 0,
            HSEDivToOTGPHY: f32 = 0,
            pllpDivToOTGPHY: f32 = 0,
            OTGPHYMult: f32 = 0,
            OTG_HS_PHYoutput: f32 = 0,
            OTGPHYRC60: f32 = 0,
            MCOMult: f32 = 0,
            MCODiv: f32 = 0,
            MCOPin: f32 = 0,
        ...
        pub const Config_Output = struct {
            ...
            HSEDivToOTGHSPHY: ?f32 = null, //from RCC Clock Config
            pllpDivToOTGHSPHY: ?f32 = null, //from RCC Clock Config
            OTGPHYPLLCLKYCLockSelection: ?OTGPHYPLLCLKYCLockSelectionList = null, //from RCC Clock Config
            ...
            HSI_Div4: ?f32 = null, //from RCC Clock Config
            ...
            OTGHSPHYEnable: ?OTGHSPHYEnableList = null, //from extra RCC references
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var usb_pll1: bool = false;
            var usb_pll1_div2: bool = false;
            ...
            const LSI1_VALUEValue: ?f32 = blk: {
                const config_val = config.LSI1_VALUE;
                if (config_val) |val| {
                    if (val < 3.14e4) {
            ...
            std.mem.doNotOptimizeAway(LSI1_VALUEValue);
            ...
            std.mem.doNotOptimizeAway(LSISource1Value);
            ...
            const SAI1CLockSelectionValue: ?SAI1CLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .@"+SAI1CLockSelectionVirtualString";
            };
            ...
            const HSEDivToOTGHSPHYValue: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(HSEDivToOTGHSPHYValue);
            const pllpDivToOTGHSPHYValue: ?f32 = blk: {
                break :blk 2;
            };

            std.mem.doNotOptimizeAway(pllpDivToOTGHSPHYValue);
            const OTGPHYPLLCLKYCLockSelectionValue: ?OTGPHYPLLCLKYCLockSelectionList = blk: {
                const conf_item = config.OTGPHYPLLCLKYCLockSelection;
                if (conf_item) |item| {
                    switch (item) {
                        .RCC_USBOTGHSPHYCLKSOURCE_HSE => {},
                        .RCC_USBOTGHSPHYCLKSOURCE_HSE_DIV2 => {},
                        .RCC_USBOTGHSPHYCLKSOURCE_PLL1P => usb_pll1 = true,
                        .RCC_USBOTGHSPHYCLKSOURCE_PLL1P_DIV2 => usb_pll1_div2 = true,
                    }
                }

                break :blk conf_item orelse .RCC_USBOTGHSPHYCLKSOURCE_HSE;
            };

            std.mem.doNotOptimizeAway(OTGPHYPLLCLKYCLockSelectionValue);
            const OTGPHYPLLCLKFreq_ValueValue: ?OTGPHYPLLCLKFreq_ValueList = blk: {
                const conf_item = config.OTGPHYPLLCLKFreq_Value;

                break :blk conf_item orelse .@"32000000";
            };

            std.mem.doNotOptimizeAway(OTGPHYPLLCLKFreq_ValueValue);
            const OTG_HS_PHY_VALUE60Value: ?f32 = blk: {
                break :blk 60000000;
            };

            std.mem.doNotOptimizeAway(OTG_HS_PHY_VALUE60Value);
            ...
            const HSI_Div4Value: ?f32 = blk: {
                break :blk 4;
            };

            std.mem.doNotOptimizeAway(HSI_Div4Value);
            ...
            const PLL1PUsedValue: ?f32 = blk: {
                if (SAI1SourcePLL1P and config.flags.SAI1_Used or config.flags.MCOConfig and mco1_pll1p or config.flags.ADC4_Used and adc_pll1p or config.flags.USB_OTG_HS_Used and (usb_pll1 or usb_pll1_div2)) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if (((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 16000000, .@"<")) or (check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 16000000, .@"="))) and config.flags.RF_Used and check_MCU("RST_HSE")) {
                    scale1 = true;
            ...
            const OTGHSPHYEnableValue: ?OTGHSPHYEnableList = blk: {
                if (config.flags.USB_OTG_HS_Used) {
                    const item: OTGHSPHYEnableList = .true;
                    break :blk item;
                }
                const item: OTGHSPHYEnableList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(OTGHSPHYEnableValue);
                        ...
                        switch (item) {
                            ...
                            .RCC_SAI1CLKSOURCE_SYSCLK => {},
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - RCC_SAI1CLKSOURCE_HSI
                                    \\ - RCC_SAI1CLKSOURCE_SYSCLK
                                , .{ "SAI1CLockSelectionVirtual", "scale2", "PLL is not allowed in range 2", item });
                            },
                        }
                    }
            ...
            std.mem.doNotOptimizeAway(SAI1CLockSelectionVirtualValue);
            ...
            var HSEDivToOTGPHY = ClockNode{
                .name = "HSEDivToOTGPHY",
                .nodetype = .off,
                .parents = &.{},
            };

            var pllpDivToOTGPHY = ClockNode{
                .name = "pllpDivToOTGPHY",
                .nodetype = .off,
                .parents = &.{},
            };

            var OTGPHYMult = ClockNode{
                .name = "OTGPHYMult",
                .nodetype = .off,
                .parents = &.{},
            };

            var OTG_HS_PHYoutput = ClockNode{
                .name = "OTG_HS_PHYoutput",
                .nodetype = .off,
                .parents = &.{},
            };

            var OTGPHYRC60 = ClockNode{
                .name = "OTGPHYRC60",
                .nodetype = .off,
                .parents = &.{},
            };
            ...
            var HSIDIV4Prescaler = ClockNode{
                .name = "HSIDIV4Prescaler",
                .nodetype = .off,
                .parents = &.{},
            };
            ...
            if (check_ref(@TypeOf(EnableHSEValue), EnableHSEValue, .true, .@"=")) {
                const HseDiv_clk_value = HseDivValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LSIEnableValue), LSIEnableValue, .true, .@"=")) {
                const LSIRC_clk_value = LSI1_VALUEValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LSIEnableValue), LSIEnableValue, .true, .@"=")) {
                const LSI2RC_clk_value = LSI2_VALUEValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LSIEnableValue), LSIEnableValue, .true, .@"=")) {
                const LSIOut_clk_value = LSISource1Value orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                ...
                const LSIOutparents = [_]*const ClockNode{
                    &LSIDIV,
                    &LSI2RC,
                };
                LSIOut.nodetype = .multi;
                LSIOut.parents = &.{LSIOutparents[LSIOut_clk_value.get()]};
            }
            ...
            if (check_ref(@TypeOf(EnableHSERFDevisorValue), EnableHSERFDevisorValue, .true, .@"=")) {
                const HSERSTDevisor_clk_value = RCC_RST_Clock_Source_FROM_HSEValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(RFEnableValue), RFEnableValue, .true, .@"=")) {
                const RSTClkSource_clk_value = RSTClockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(ASEnableValue), ASEnableValue, .true, .@"=")) {
                const ASMult_clk_value = ASClockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(RNGEnableValue), RNGEnableValue, .true, .@"=")) {
                const pllqDivToRNG_clk_value = pllqDivToRNGValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_MCU("USB_OTG_HS_Exist")) {
                if (check_ref(@TypeOf(EnableHSEValue), EnableHSEValue, .true, .@"=")) {
                    const HSEDivToOTGPHY_clk_value = HSEDivToOTGHSPHYValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    ...
                    HSEDivToOTGPHY.nodetype = .div;
                    HSEDivToOTGPHY.value = HSEDivToOTGPHY_clk_value;
                    HSEDivToOTGPHY.parents = &.{&HSEOSC};
                }
            }
            if (check_MCU("USB_OTG_HS_Exist")) {
                if (check_ref(@TypeOf(ASEnableValue), ASEnableValue, .true, .@"=") or
                    ...
                    check_ref(@TypeOf(OTGHSPHYEnableValue), OTGHSPHYEnableValue, .true, .@"="))
                {
                    const pllpDivToOTGPHY_clk_value = pllpDivToOTGHSPHYValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    ...
                    pllpDivToOTGPHY.nodetype = .div;
                    pllpDivToOTGPHY.value = pllpDivToOTGPHY_clk_value;
                    pllpDivToOTGPHY.parents = &.{&PLL1P};
                }
            }
            if (check_MCU("USB_OTG_HS_Exist")) {
                if (check_ref(@TypeOf(OTGHSPHYEnableValue), OTGHSPHYEnableValue, .true, .@"=")) {
                    const OTGPHYMult_clk_value = OTGPHYPLLCLKYCLockSelectionValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    , .{
                        ...
                        "USB_OTG_HS_Exist",
                        "No Extra Log",
                        "OTGPHYPLLCLKYCLockSelection",
                    });
                    const OTGPHYMultparents = [_]*const ClockNode{
                        &HSEOSC,
                        &HSEDivToOTGPHY,
                        &PLL1P,
                        &pllpDivToOTGPHY,
                    };
                    OTGPHYMult.nodetype = .multi;
                    OTGPHYMult.parents = &.{OTGPHYMultparents[OTGPHYMult_clk_value.get()]};
                }
            }
            if (check_MCU("USB_OTG_HS_Exist")) {
                if (check_ref(@TypeOf(OTGHSPHYEnableValue), OTGHSPHYEnableValue, .true, .@"=")) {
                    OTG_HS_PHYoutput.nodetype = .output;
                    OTG_HS_PHYoutput.parents = &.{&OTGPHYMult};
                }
            }
            if (check_MCU("USB_OTG_HS_Exist")) {
                if (check_ref(@TypeOf(OTGHSPHYEnableValue), OTGHSPHYEnableValue, .true, .@"=")) {
                    const OTGPHYRC60_clk_value = OTG_HS_PHY_VALUE60Value orelse try comptime_fail_or_error(error.InvalidClockValue,
                        \\Error on Clock {s} | expr: {s} diagnostic: {s}
                        \\Clock is active but the reference value {s} is null
                        \\note: check the flags and configurations associated with this clock
                        \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
                    ...
                    OTGPHYRC60.nodetype = .source;
                    OTGPHYRC60.value = OTGPHYRC60_clk_value;
                }
            }
            ...
            const AHB5Prescaler_clk_value = AHB5CLKDividerValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const HSIDIV4Prescaler_clk_value = HSI_Div4Value orelse try comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            HSIDIV4Prescaler.nodetype = .div;
            HSIDIV4Prescaler.value = HSIDIV4Prescaler_clk_value;
            HSIDIV4Prescaler.parents = &.{&HSIRC};
            ...
            const APB7Prescaler_clk_value = APB7CLKDividerValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            out.HSEDivToOTGPHY = try HSEDivToOTGPHY.get_output();
            out.pllpDivToOTGPHY = try pllpDivToOTGPHY.get_output();
            out.OTGPHYMult = try OTGPHYMult.get_output();
            out.OTG_HS_PHYoutput = try OTG_HS_PHYoutput.get_output();
            out.OTGPHYRC60 = try OTGPHYRC60.get_output();
            ...
            out.HSIDIV4Prescaler = try HSIDIV4Prescaler.get_output();
            ...
            ref_out.HSEDivToOTGHSPHY = HSEDivToOTGHSPHYValue;
            ref_out.pllpDivToOTGHSPHY = pllpDivToOTGHSPHYValue;
            ref_out.OTGPHYPLLCLKYCLockSelection = OTGPHYPLLCLKYCLockSelectionValue;
            ...
            ref_out.HSI_Div4 = HSI_Div4Value;
            ...
            ref_out.OTGHSPHYEnable = OTGHSPHYEnableValue;
