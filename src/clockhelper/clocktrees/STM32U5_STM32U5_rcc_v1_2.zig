...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Flags = struct {
            ...
            RCC_MSIKRANGE_0: bool = false,
            RCC_MSIRANGE_0: bool = false,
            DAC1: bool = false,
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
                ...
                if ((check_ref(@TypeOf(LSEStateValue), LSEStateValue, .RCC_LSE_OFF, .@"=")) and ((((config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_DRD_FS_Used) or (SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) and CK48SourcePLL1Q and PLLSourceMSI) or (((config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_DRD_FS_Used) or (SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC))) and CK48SourcePLL2Q and PLL2SourceMSI))) {
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIS) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(LSEState=RCC_LSE_OFF) & ((((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)))&CK48SourcePLL1Q&PLLSourceMSI)|(((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)))&CK48SourcePLL2Q&PLL2SourceMSI))",
                                "",
                                "PLLMODE_MSIS",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIS) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "((((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)))&CK48SourcePLL1Q&PLLSourceMSI)|(((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC)))&CK48SourcePLL2Q&PLL2SourceMSI))",
                                "",
                                "PLLMODE_MSIS",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIK) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(LSEState=RCC_LSE_OFF) & (((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))) & CLK48CLKSOURCE_MSIK)",
                                "",
                                "PLLMODE_MSIK",
                                val,
                            });
                    ...
                    if (config.extra_config.MSIAutoCalibration) |val| {
                        if (val != .PLLMODE_MSIK) {
                            ...
                            , .{
                                "MSIAutoCalibration",
                                "(((USB_OTG_FSUsed_ForRCC | USB_DRD_FS_Used) |(SDMMC1SourceIsClock48 & (SDMMC1Used_ForRCC | SDMMC2Used_ForRCC))) & CLK48CLKSOURCE_MSIK)",
                                "",
                                "PLLMODE_MSIK",
                                val,
                            });
            ...
            const PLL2RUsedValue: u1 = blk: {
                if ((ADCSourcePLL2R and config.flags.DAC1) or (ADCSourcePLL2R and ((config.flags.USE_ADC1 and config.flags.ADC1UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC2 and config.flags.ADC2UsedAsynchronousCLK_ForRCC) or (config.flags.USE_ADC4 and config.flags.ADCUsed_ForRCC)))) {
                    break :blk 1;
                }
                break :blk 0;
            };
            ...
            const USBEnableValue: USBEnableList = blk: {
                if ((config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_DRD_FS_Used) and !config.flags.S_LPBAM_CONF) {
                    break :blk .true;
                }
                break :blk .false;
            };
            ...
            const FullHSI48UsedValue: u1 = blk: {
                if (RNGCLKSOURCE_HSI48 and config.flags.RNGUsed_ForRCC or (CK48SourceHSI48 and SDMMC1SourceIsClock48 and (config.flags.SDMMC1Used_ForRCC or config.flags.SDMMC2Used_ForRCC)) or config.flags.CRSActivatedSourceGPIO or config.flags.CRSActivatedSourceLSE or config.flags.CRSActivatedSourceUSB or (CK48SourceHSI48 and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_DRD_FS_Used)) or ((check_ref(@TypeOf(RCC_MCO1SourceVirtualValue), RCC_MCO1SourceVirtualValue, .RCC_MCO1SOURCE_HSI48, .@"=")) and ((((config.flags.Semaphore_input_Channel1TIM16 and config.flags.TIM16 and config.flags.SEM2RCC_MCO_REQUIRED_TIM16) or config.flags.MCOConfig))))) {
                    break :blk 1;
                }
                break :blk 0;
            };
                        ...
                        switch (val) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                                ...
                                , .{
                                    ...
                                    "((SYSCLKFreq_VALUE <25000000) | (SYSCLKFreq_VALUE =25000000))",
