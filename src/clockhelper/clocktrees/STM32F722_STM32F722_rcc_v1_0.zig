    ...
    return struct {
            ...
            pub fn from_enum(item: RCC_SAISEL) anyerror!@This() {
                return switch (item) {
                    ...
                    .PLLI2S1_Q => .RCC_SAI1CLKSOURCE_PLLI2S,
                        ...
                        .{ "RCC_SAISEL", @tagName(item), "SAI1CLockSelection" },
                    ),
                };
            }
        };
            ...
            pub fn from_enum(item: RCC_SAISEL) anyerror!@This() {
                return switch (item) {
                    ...
                    .AFIF => .RCC_SAI2CLKSOURCE_PIN,
                        ...
                        error.UnmappedListItem,
                        "{s} - {s} cannot be mapped to {s}List",
                        .{ "RCC_SAISEL", @tagName(item), "SAI2CLockSelection" },
                    ),
                };
            }
        };
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            const HSE_VALUEValue: f32 = blk: {
                if (check_MCU("STM32F7x3") and (config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 12000000, .@"=")) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 12500000, .@"=")) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 16000000, .@"=")) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 25000000, .@"=")) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 24000000, .@"=")) and !(check_ref(@TypeOf(config.base.HSE_VALUE), config.base.HSE_VALUE, 32000000, .@"="))) {
                    ...
                    HSEOSC.limit = .{
                        .min = 2.5e7,
                        .max = 2.5e7,
                        .main_expr = "STM32F7x3 &(USB_OTG_HSEmbeddedPHYUsed_ForRCC) & !(HSE_VALUE=12000000)& !(HSE_VALUE=12500000)& !(HSE_VALUE=16000000)& !(HSE_VALUE=25000000)& !(HSE_VALUE=24000000)& !(HSE_VALUE=32000000)",
            ...
            if ((USBSourceisPLL and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC1Used_ForRCC and SDMMC1SourceCK48) or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48)))) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 7.5e7,
                    .main_expr = "(USBSourceisPLL & (USB_OTG_FSUsed_ForRCC|USB_OTG_HSEmbeddedPHYUsed_ForRCC|RNGUsed_ForRCC|(SDMMC1Used_ForRCC&SDMMC1SourceCK48)|(SDMMC2Used_ForRCC&SDMMC2SourceCK48)))",
            ...
            if ((((config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.USB_OTG_FSUsed_ForRCC or config.flags.RNGUsed_ForRCC or (SDMMC1SourceCK48 and config.flags.SDMMC1Used_ForRCC) or (config.flags.SDMMC2Used_ForRCC and SDMMC2SourceCK48)) and USBSourceisPLLSAI))) {
                PLLSAIoutput.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "(((USB_OTG_HSEmbeddedPHYUsed_ForRCC|USB_OTG_FSUsed_ForRCC|RNGUsed_ForRCC|(SDMMC1SourceCK48 &SDMMC1Used_ForRCC)|(SDMMC2Used_ForRCC&SDMMC2SourceCK48))&USBSourceisPLLSAI))",
            ...
            if (((SAI1SourcePLLSAI and (config.flags.SAI1Used_ForRCC)) or (SAI2SourcePLLSAI and config.flags.SAI2Used_ForRCC))) {
                PLLSAIQCLK.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "((SAI1SourcePLLSAI &(SAI1Used_ForRCC))| (SAI2SourcePLLSAI&SAI2Used_ForRCC))",
                    .main_dialog = "PLL not used",
                };
            }
            ...
            if (((SAI1SourcePLLI2S and (config.flags.SAI1Used_ForRCC)) or (SAI2SourcePLLI2S and config.flags.SAI2Used_ForRCC))) {
                PLLI2SQCLK.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "((SAI1SourcePLLI2S &(SAI1Used_ForRCC))| (SAI2SourcePLLI2S&SAI2Used_ForRCC))",
                    .main_dialog = "PLL not used",
                };
            }
            ...
            if (!(check_ref(@TypeOf(USBEnableValue), USBEnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMCEnableValue), SDMMCEnableValue, .true, .@"=") or check_ref(@TypeOf(SDMMC2EnableValue), SDMMC2EnableValue, .true, .@"=") or check_ref(@TypeOf(RNGEnableValue), RNGEnableValue, .true, .@"="))) {
