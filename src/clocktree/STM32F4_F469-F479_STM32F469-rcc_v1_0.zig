...
pub const SAIACLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_SAIACLKSOURCE_EXT => 0,
            .RCC_SAIACLKSOURCE_PLLI2S => 1,
            .RCC_SAIACLKSOURCE_PLLSAI => 2,
        };
    }
};
pub const SAIBCLockSelectionList = enum {
    ...
    pub fn get(self: @This()) usize {
        return switch (self) {
            .RCC_SAIBCLKSOURCE_EXT => 0,
            .RCC_SAIBCLKSOURCE_PLLI2S => 1,
            .RCC_SAIBCLKSOURCE_PLLSAI => 2,
        };
    }
};
...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Config_Output = struct {
            ...
            EnableI2S: ?EnableI2SList = null, //from extra RCC references
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var SAIASourceIsPLLI2S: bool = false;
            var SAIASourceIsEXT: bool = false;
            var SAIBSourceIsPLLSAI: bool = false;
            var SAIBSourceIsPLLI2S: bool = false;
            var SAIBSourceIsEXT: bool = false;
            var I2SSourceIsPLLI2S: bool = false;
            var I2SSourceIsEXT: bool = false;
            var MCOSourceIsPLLI2S: bool = false;
            ...
            std.mem.doNotOptimizeAway(SDIOCLockSelectionValue);
            ...
            const SAIACLockSelectionValue: ?SAIACLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SAIACLKSOURCE_PLLSAI;
            };

            std.mem.doNotOptimizeAway(SAIACLockSelectionValue);
            ...
            const SAIBCLockSelectionValue: ?SAIBCLockSelectionList = blk: {
                ...
                break :blk conf_item orelse .RCC_SAIBCLKSOURCE_PLLSAI;
            };

            std.mem.doNotOptimizeAway(SAIBCLockSelectionValue);
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if (((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 168000000, .@">")))) {
                    ...
                    break :blk item;
                } else if (((check_ref(@TypeOf(PWREXT_OverDriveValue), PWREXT_OverDriveValue, .PWREXT_OverDrive_DESACTIVATED, .@"=")) and ((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 144000000, .@">"))))) {
                    const item: PWR_Regulator_Voltage_ScaleList = .PWR_REGULATOR_VOLTAGE_SCALE1;
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |i| {
                        if (item != i) {
                            try comptime_fail_or_error(error.InvalidConfig,
                                ...
                                \\select the expected option or leave the value as null.
                                \\
                            , .{ "PWR_Regulator_Voltage_Scale", "((PWREXT_OverDrive=PWREXT_OverDrive_DESACTIVATED)&((HCLKFreq_Value > 144000000)))", "No Extra Log", "PWR_REGULATOR_VOLTAGE_SCALE1", i });
                        }
                    }
                    break :blk item;
                        ...
                        switch (item) {
                            ...
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => {},
                                ...
                                try comptime_fail_or_error(error.InvalidConfig,
                                    ...
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE2
                                    \\ - PWR_REGULATOR_VOLTAGE_SCALE1
                                , .{ "PWR_Regulator_Voltage_Scale", "(HCLKFreq_Value > 120000000) | (HCLKFreq_Value = 144000000) ", "No Extra Log", item });
                            },
                        }
                    }
            ...
            std.mem.doNotOptimizeAway(PWREXT_OverDriveValue);
            ...
            const APB1Freq_ValueValue: ?f32 = blk: {
                if ((((check_ref(@TypeOf(HCLKFreq_ValueValue), HCLKFreq_ValueValue, 168000000, .@">")) or (check_ref(@TypeOf(SYSCLKFreq_VALUEValue), SYSCLKFreq_VALUEValue, 168000000, .@">"))) and ((check_ref(@TypeOf(VDD_VALUEValue), VDD_VALUEValue, 1.8, .@"<")) or (check_ref(@TypeOf(VDD_VALUEValue), VDD_VALUEValue, 2.1, .@">")))) and ((check_MCU("I2C_Fast") and (config.flags.I2C1Used_ForRCC or config.flags.I2C2Used_ForRCC or config.flags.I2C3Used_ForRCC)))) {
                    APB1Freq_ValueLimit = .{
                        .min = 4e6,
                        .max = 4.5e7,
                    };
            ...
            const PLLRFreq_ValueValue: ?f32 = blk: {
                break :blk 96000000;
            };

            std.mem.doNotOptimizeAway(PLLRFreq_ValueValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAINValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAIPValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAIQValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAIQDivValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAIRValue);
            ...
            std.mem.doNotOptimizeAway(PLLSAIRDivValue);
            ...
            std.mem.doNotOptimizeAway(PLLI2SQValue);
            ...
            std.mem.doNotOptimizeAway(PLLI2SQDivValue);
            ...
            std.mem.doNotOptimizeAway(EnableSDIOValue);
            ...
            std.mem.doNotOptimizeAway(EnableSAIAValue);
            ...
            std.mem.doNotOptimizeAway(EnableSAIBValue);
            const EnableI2SValue: ?EnableI2SList = blk: {
                if (config.flags.I2SUsed_ForRCC) {
                    const item: EnableI2SList = .true;
                    break :blk item;
                }
                const item: EnableI2SList = .false;
                break :blk item;
            };

            std.mem.doNotOptimizeAway(EnableI2SValue);
            ...
            if (check_ref(@TypeOf(EnableI2SValue), EnableI2SValue, .true, .@"=")) {
                I2Soutput.limit = I2SFreq_ValueLimit;
            ...
            if (check_ref(@TypeOf(EnableUSBValue), EnableUSBValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSDIOValue), EnableSDIOValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSAIAValue), EnableSAIAValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSAIBValue), EnableSAIBValue, .true, .@"=") or
            ...
            if (check_ref(@TypeOf(EnableSAIAValue), EnableSAIAValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSAIBValue), EnableSAIBValue, .true, .@"="))
            {
            ...
            if (check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=")) {
                const PLLSAIR_clk_value = PLLSAIRValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(LTDCEnableValue), LTDCEnableValue, .true, .@"=")) {
                const PLLSAIRDiv_clk_value = PLLSAIRDivValue orelse try comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(EnableSAIAValue), EnableSAIAValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSAIBValue), EnableSAIBValue, .true, .@"=") or
                check_ref(@TypeOf(EnableSAIAValue), EnableSAIAValue, .true, .@"=") or
                check_ref(@TypeOf(EnableI2SValue), EnableI2SValue, .true, .@"=") or
            ...
            if (check_ref(@TypeOf(EnableI2SValue), EnableI2SValue, .true, .@"=") or
                check_ref(@TypeOf(MCO2OutPutEnableValue), MCO2OutPutEnableValue, .true, .@"="))
            {
            ...
            ref_out.EnableI2S = EnableI2SValue;
