...
pub const ADC345CLockSelectionConf = enum {
...
pub const Config = struct {
    ...
    I2SMult: I2SCLockSelectionConf = .RCC_I2SCLKSOURCE_SYSCLK,
    SAI1Mult: SAI1CLockSelectionConf = .RCC_SAI1CLKSOURCE_SYSCLK,
    QSPIMult: QSPICLockSelectionConf = .RCC_QSPICLKSOURCE_SYSCLK,
    ...
    ADC12Mult: ADC12CLockSelectionConf = .RCC_ADC12CLKSOURCE_SYSCLK,
    ADC345Mult: ADC345CLockSelectionConf = .RCC_ADC345CLKSOURCE_SYSCLK,
    CK48Mult: CK48CLockSelectionConf = .RCC_USBCLKSOURCE_HSI48,
...
pub const ConfigWithRef = struct {
    ...
    I2SCLockSelection: I2SCLockSelectionConf = .RCC_I2SCLKSOURCE_SYSCLK,
    SAI1CLockSelection: SAI1CLockSelectionConf = .RCC_SAI1CLKSOURCE_SYSCLK,
    QSPICLockSelection: QSPICLockSelectionConf = .RCC_QSPICLKSOURCE_SYSCLK,
    ...
    ADC12CLockSelection: ADC12CLockSelectionConf = .RCC_ADC12CLKSOURCE_SYSCLK,
    ADC345CLockSelection: ADC345CLockSelectionConf = .RCC_ADC345CLKSOURCE_SYSCLK,
    CK48CLockSelection: CK48CLockSelectionConf = .RCC_USBCLKSOURCE_HSI48,
    ...
    pub fn into_config(self: *const ConfigWithRef) Config {
        return .{
            ...
            .ADC345Mult = self.ADC345CLockSelection,
...
pub const ClockTree = struct {
    ...
    ADC345Mult: ClockNode,
    ADC345output: ClockNode,
    CK48Mult: ClockNode,
    ...
    pub fn init_comptime(comptime config: Config) this {
        ...
        const IWDGOutputval = ClockNodeTypes{
            .output = .{ .max = 170000000, .min = 0 },
        };
        ...
        const ADC12outputval = ClockNodeTypes{
            .output = .{ .max = 170000000, .min = 140000 },
        };
        ...
        const ADC345Multval = ClockNodeTypes{ .multi = @intFromEnum(config.ADC345Mult) };
        const ADC345Mult: ClockNode = .{
            .name = "ADC345Mult",
            .Nodetype = ADC345Multval,
        ...
        const ADC345outputval = ClockNodeTypes{
            .output = .{ .max = 170000000, .min = 0 },
        };
        const ADC345output: ClockNode = .{
            .name = "ADC345output",
            .Nodetype = ADC345outputval,
            .parents = &[_]*const ClockNode{&ADC345Mult},
        };
        ...
        const HRTIM1CLKoutputval = ClockNodeTypes{ .output = null };
        const HRTIM1CLKoutput: ClockNode = .{
            .name = "HRTIM1CLKoutput",
            .Nodetype = HRTIM1CLKoutputval,
            .parents = &[_]*const ClockNode{&TimPrescOut2},
        };
        ...
        return .{
            ...
            .ADC345Mult = ADC345Mult,
            .ADC345output = ADC345output,
            .CK48Mult = CK48Mult,
            ...
            .HRTIM1CLKoutput = HRTIM1CLKoutput,
    ...
    pub fn validate(comptime self: *const this) void {
        ...
        _ = self.ADC345output.get_comptime();
        ...
        _ = self.HRTIM1CLKoutput.get_comptime();
