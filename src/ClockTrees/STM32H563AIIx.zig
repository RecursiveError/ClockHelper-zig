...
pub const Config = struct {
    ...
    UART12Mult: ?UART12CLockSelectionConf = null,
...
pub const ConfigWithRef = struct {
    ...
    UART12CLockSelection: ?UART12CLockSelectionConf = null,
...
pub const ClockTree = struct {
    ...
    pub fn init(comptime config: Config) Self {
        ...
        const UART12Multval = ClockNodeTypes{
            .multi = inner: {
                if (config.UART12Mult) |val| {
                    break :inner val.get();
                } else {
                    break :inner 0;
                }
        ...
        const SDMMC2Outputval = ClockNodeTypes{ .output = null };
        ...
        const SPI5outputval = ClockNodeTypes{ .output = null };
    ...
    pub fn init_runtime_tree(self: *Self, alloc: std.mem.Allocator) !void {
        ...
        self.USART11Mult.parents = try alloc.dupe(*const ClockNode, &.{
            &self.APB1Prescaler,
            &self.PLL2Q,
            &self.HSIDiv,
            &self.LSEOSC,
        ...
        self.USART11output.parents = try alloc.dupe(*const ClockNode, &.{
            &self.USART11Mult,
        });
        self.UART12Mult.parents = try alloc.dupe(*const ClockNode, &.{
            &self.APB1Prescaler,
            &self.PLL2Q,
            &self.HSIDiv,
            &self.LSEOSC,
        ...
        self.UART12output.parents = try alloc.dupe(*const ClockNode, &.{
            &self.UART12Mult,
        });
        ...
        self.ETHoutput.parents = try alloc.dupe(*const ClockNode, &.{
            &self.PLL1Q,
        });
        ...
        self.LPTIM6Mult.parents = try alloc.dupe(*const ClockNode, &.{
            &self.APB3Output,
            &self.PLL2P,
            &self.LSEOSC,
            &self.LSIRC,
        ...
        self.LPTIM6output.parents = try alloc.dupe(*const ClockNode, &.{
            &self.LPTIM6Mult,
        });
    ...
    pub fn deinit_runtime_tree(self: *Self, alloc: std.mem.Allocator) void {
        ...
        alloc.free(self.USART11Mult.parents.?);
        alloc.free(self.USART11output.parents.?);
        alloc.free(self.UART12Mult.parents.?);
        alloc.free(self.UART12output.parents.?);
        ...
        alloc.free(self.ETHoutput.parents.?);
        ...
        alloc.free(self.LPTIM6Mult.parents.?);
        alloc.free(self.LPTIM6output.parents.?);
    ...
    pub fn runtime_apply(self: *Self, config: Config) error{InvalidConfig}!void {
        ...
        self.USART11Mult.nodetype = USART11Multval;
        const USART11outputval = ClockNodeTypes{ .output = null };
        self.USART11output.nodetype = USART11outputval;
        const UART12Multval = ClockNodeTypes{
            .multi = inner: {
                if (config.UART12Mult) |val| {
                    break :inner val.get();
        ...
        self.UART12Mult.nodetype = UART12Multval;
        const UART12outputval = ClockNodeTypes{ .output = null };
        self.UART12output.nodetype = UART12outputval;
        const APB3Prescalerval = ClockNodeTypes{ .div = .{
            .value = inner: {
                if (config.APB3Prescaler) |val| {
                    break :inner val.get();
        ...
        const ETHoutputval = ClockNodeTypes{ .output = null };
        self.ETHoutput.nodetype = ETHoutputval;
        const USBoutputval = ClockNodeTypes{
            .output = .{ .max = @min(1_000_000_000, 50000000), .min = 0 },
        };
        ...
        self.LPTIM6Mult.nodetype = LPTIM6Multval;
        const LPTIM6outputval = ClockNodeTypes{ .output = null };
        self.LPTIM6output.nodetype = LPTIM6outputval;
        const RNGMultval = ClockNodeTypes{
            .multi = inner: {
                if (config.RNGMult) |val| {
                    break :inner val.get();
