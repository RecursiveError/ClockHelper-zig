...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub fn get_cubemx_clocks(config: CubeMXConfig, comptime patch_logs: bool) anyerror!CubemxTreeOutput {
            ...
            //======= LCDTFToutputFreq_Value ========
            const LCDTFToutputFreq_ValueValue = LCDTFTKOutput.get_as_ref();
            ignore_value(LCDTFToutputFreq_ValueValue);
            ...
            if ((USBSourceisPLL and (config.flags.USB_OTG_FSUsed_ForRCC or config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.RNGUsed_ForRCC or (config.flags.SDMMC1Used_ForRCC and SDMMC1SourceCK48)))) {
                PLLQoutput.limit = .{
                    .min = null,
                    .max = 7.5e7,
                    .main_expr = "(USBSourceisPLL & (USB_OTG_FSUsed_ForRCC|USB_OTG_HSEmbeddedPHYUsed_ForRCC|RNGUsed_ForRCC|(SDMMC1Used_ForRCC&SDMMC1SourceCK48)))",
            ...
            if ((((config.flags.USB_OTG_HSEmbeddedPHYUsed_ForRCC or config.flags.USB_OTG_FSUsed_ForRCC or config.flags.RNGUsed_ForRCC or (SDMMC1SourceCK48 and config.flags.SDMMC1Used_ForRCC)) and USBSourceisPLLSAI))) {
                PLLSAIoutput.limit = .{
                    .min = null,
                    .max = 2.16e8,
                    .main_expr = "(((USB_OTG_HSEmbeddedPHYUsed_ForRCC|USB_OTG_FSUsed_ForRCC|RNGUsed_ForRCC|(SDMMC1SourceCK48 &SDMMC1Used_ForRCC))&USBSourceisPLLSAI))",
